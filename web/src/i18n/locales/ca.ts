    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Desat. La connexió es tancarà ara — torna a obrir NanoKVM a {{url}}',
          warning: "Canviar l'adreça IP desconnecta la sessió actual. Un valor incorrecte pot deixar-te fora de la interfície web (la recuperació requereix accés físic/targeta SD). Assegura't que l'adreça, la màscara i la passarel·la són correctes.",
          confirmTitle: "Canviar l'adreça IP?",
          confirmStatic: 'La connexió per cable es reconfigurarà immediatament i aquesta sessió es tancarà. Després obre NanoKVM a {{url}}. Vols continuar?',
