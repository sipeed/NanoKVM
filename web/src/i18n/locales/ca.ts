  ...
  translation: {
    ...
    settings: {
      ...
      users: {
        ...
        colEnabled: 'Actiu',
        colActions: 'Accions',
        rolesTitle: 'Resum de rols',
        roleAdmin: "Accés complet + gestió d'usuaris",
        roleOperator: "Ús del KVM: vídeo, teclat, ratolí, botons d'energia",
        roleViewer: 'Només visualitzar el vídeo',
        changePassword: 'Canviar contrasenya',
        ...
        password: 'Contrasenya',
        delete: 'Esborra',
        deleteConfirm: 'Segur que voleu esborrar aquest usuari?',
        createSuccess: 'Usuari creat',
        createFailed: "No s'ha pogut crear",
        ...
        usernameRequired: "Introduïu un nom d'usuari",
        passwordRequired: 'Introduïu una contrasenya',
        okBtn: "D'acord",
        cancelBtn: 'Cancel·la'
      },
      audit: {
        ...
        filterUser: 'Filtra per usuari',
        count: '{{count}} entrades',
        loadFailed: 'No s\'ha pogut carregar el registre d\'activitat',
        enableSuccess: 'Registre d\'activitat activat',
        disableSuccess: 'Registre d\'activitat desactivat',
        updateFailed: 'No s\'ha pogut actualitzar la configuració'
      },
      account: {
        title: 'Compte',
