  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'Adreça IP',
          description: 'Configura la connexió per cable (eth0)',
          dhcp: 'DHCP',
          static: 'Manual',
          addressing: 'Configuració IPv4',
          dhcpDescription: "L'adreça IP s'obté automàticament per DHCP",
          staticDescription: 'Defineix una adreça IP fixa, màscara de subxarxa i passarel·la',
          ipAddress: 'Adreça IP',
          subnetMask: 'Màscara de subxarxa',
          gateway: 'Passarel·la',
          save: 'Desa',
          unsaved: 'Canvis no desats',
          invalidAddress: 'Introdueix una adreça IP vàlida',
          invalidMask: 'Introdueix una màscara de subxarxa vàlida',
          invalidGateway: 'Introdueix una adreça de passarel·la vàlida',
          gatewaySubnet: "La passarel·la ha d'estar a la mateixa subxarxa que l'adreça IP",
          saveFailed: "No s'han pogut desar els ajustaments d'IP",
          savedDhcp: "S'ha canviat a DHCP. L'adreça IP pot canviar aviat.",
          savedReconnect: 'Desat. La connexió es tancarà ara — torna a obrir NanoKVM a {{url}} i confirma-ho allà en 5 minuts, si no es revertirà.',
          confirmPendingTitle: 'Confirma la nova adreça IP',
          confirmPendingText: 'Es tornarà a la configuració anterior en {{time}} si no ho confirmes.',
          confirmKeep: 'Mantén la configuració',
          confirmed: 'Configuració IP confirmada',
          confirmFailed: 'La confirmació ha fallat',
          reverted: "No confirmat — s'ha tornat a la configuració anterior",
          warning: "Canviar l'adreça IP desconnecta aquesta sessió. Després tens 5 minuts per tornar a connectar-te a la nova adreça i confirmar-la; altrament el dispositiu tornarà automàticament a la configuració anterior. Assegura't que l'adreça, la màscara i la passarel·la siguin correctes.",
          confirmTitle: "Canviar l'adreça IP?",
          confirmStatic: 'La connexió per cable es reconfigurarà immediatament i aquesta sessió es tancarà. Torna a connectar-te a {{url}} i confirma en 5 minuts, si no es revertirà automàticament. Vols continuar?',
          confirmDhcp: 'La connexió per cable canviarà a DHCP immediatament i aquesta sessió es pot tancar. Vols continuar?',
          confirmOk: 'Aplica',
      ...
      audit: {
        ...
        clearConfirmTitle: "Esborrar tot el registre d'activitat?",
        clearConfirmText: 'Això elimina permanentment totes les entrades i no es pot desfer.',
        clearConfirmOk: 'Esborra',
        clearConfirmCancel: 'Cancel·la',
        clearSuccess: "Registre d'activitat esborrat",
        clearFailed: "No s'ha pogut esborrar el registre",
        colTime: 'Hora',
        colUser: 'Usuari',
        colAction: 'Acció',
        colIp: 'IP',
        ...
        actions: {
          ...
          changePassword: 'canviar la pròpia contrasenya',
          createUser: 'crear usuari',
          updateUser: 'actualitzar usuari',
          deleteUser: 'eliminar usuari',
          changeUserPassword: 'canviar la contrasenya de l\'usuari',
          auditConfig: 'canviar la configuració del registre',
          clearAudit: 'esborrar registre',
          gpio: 'botó d\'engegada/reinici',
          reboot: 'reiniciar el dispositiu',
          usbRecover: 'recuperar USB',
          sshEnable: 'activar SSH',
          sshDisable: 'desactivar SSH',
          hdmiEnable: 'activar HDMI',
          hdmiDisable: 'desactivar HDMI',
          hdmiReset: 'restablir HDMI',
          mdnsEnable: 'activar mDNS',
          mdnsDisable: 'desactivar mDNS',
          hostname: 'definir nom d\'amfitrió',
          webTitle: 'definir títol web',
          tls: 'configurar TLS',
          oled: 'configurar OLED',
          swap: 'configurar swap',
          memoryLimit: 'definir límit de memòria',
          virtualDevice: 'configurar dispositiu virtual',
          mouseJiggler: 'definir mouse jiggler',
          runScript: 'executar script',
          uploadScript: 'pujar script',
          deleteScript: 'eliminar script',
          autostartSet: 'definir inici automàtic',
          autostartDelete: 'eliminar inici automàtic',
          terminal: 'obrir terminal web',
          hidPaste: 'enganxar text',
          hidMode: 'canviar mode HID',
          hidReset: 'restablir HID',
          shortcutAdd: 'afegir drecera',
          shortcutDelete: 'eliminar drecera',
          leaderKey: 'definir tecla líder',
          setDns: 'definir DNS',
          setIp: 'definir adreça IP',
          wifiConnect: 'connectar Wi-Fi',
          wifiDisconnect: 'desconnectar Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'definir nom MAC',
          wolMacDelete: 'eliminar MAC',
          imageMount: 'muntar mitjà virtual',
          imageDelete: 'eliminar imatge',
          imageDownload: 'baixar imatge',
          firmwareUpdate: 'actualitzar firmware',
          firmwareUpdateOffline: 'actualitzar firmware (fora de línia)',
          firmwarePreview: 'definir canal de vista prèvia',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'iniciar Tailscale',
          tsStop: 'aturar Tailscale',
          tsRestart: 'reiniciar Tailscale',
          tsInstall: 'instal·lar Tailscale',
          tsUninstall: 'desinstal·lar Tailscale',
          tsLogin: 'inici de sessió Tailscale',
          tsLogout: 'tancament de sessió Tailscale'
        }
      },
      account: {
        title: 'Compte',
