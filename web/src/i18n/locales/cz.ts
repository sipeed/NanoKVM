  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP adresa',
          description: 'Konfigurace kabelového připojení (eth0)',
          dhcp: 'DHCP',
          static: 'Ručně',
          addressing: 'Konfigurace IPv4',
          dhcpDescription: 'IP adresa se získává automaticky přes DHCP',
          staticDescription: 'Nastavte pevnou IP adresu, masku podsítě a bránu',
          ipAddress: 'IP adresa',
          subnetMask: 'Maska podsítě',
          gateway: 'Brána',
          save: 'Uložit',
          ...
          invalidMask: 'Zadejte platnou masku podsítě',
          invalidGateway: 'Zadejte platnou adresu brány',
          gatewaySubnet: 'Brána musí být ve stejné podsíti jako IP adresa',
          saveFailed: 'Nepodařilo se uložit nastavení IP',
          savedDhcp: 'Přepnuto na DHCP. IP adresa se může brzy změnit.',
          savedReconnect: 'Uloženo. Připojení se nyní přeruší — znovu otevřete NanoKVM na {{url}} a do 5 minut potvrďte, jinak se vrátí zpět.',
          confirmPendingTitle: 'Potvrďte novou IP adresu',
          confirmPendingText: 'Návrat k předchozí konfiguraci za {{time}}, pokud nepotvrdíte.',
          confirmKeep: 'Ponechat konfiguraci',
          confirmed: 'Konfigurace IP potvrzena',
          confirmFailed: 'Potvrzení se nezdařilo',
          reverted: 'Nepotvrzeno — návrat k předchozí konfiguraci',
          warning: 'Změna IP adresy přeruší tuto relaci. Poté máte 5 minut na opětovné připojení na novou adresu a potvrzení; jinak se zařízení automaticky vrátí k předchozí konfiguraci. Ujistěte se, že adresa, maska a brána jsou správné.',
          confirmTitle: 'Změnit IP adresu?',
          confirmStatic: 'Kabelové připojení se okamžitě překonfiguruje a tato relace se přeruší. Znovu se připojte na {{url}} a do 5 minut potvrďte, jinak se automaticky vrátí. Pokračovat?',
          confirmDhcp: 'Kabelové připojení se okamžitě přepne na DHCP a tato relace se může přerušit. Pokračovat?',
          confirmOk: 'Použít',
      ...
      users: {
        ...
        colEnabled: 'Aktivní',
        colActions: 'Akce',
        rolesTitle: 'Přehled rolí',
        roleAdmin: 'Plný přístup + správa uživatelů',
        roleOperator: 'Použití KVM: video, klávesnice, myš, napájecí tlačítka',
        roleViewer: 'Pouze sledování videa',
        changePassword: 'Změnit heslo',
        newPassword: 'Nové heslo',
        confirmPassword: 'Potvrdit heslo',
        pwdMismatch: 'Hesla se neshodují',
        pwdSuccess: 'Heslo bylo úspěšně změněno',
        pwdFailed: 'Změna hesla se nezdařila',
        password: 'Heslo',
        delete: 'Smazat',
        deleteConfirm: 'Opravdu smazat tohoto uživatele?',
        createSuccess: 'Uživatel vytvořen',
        createFailed: 'Vytvoření se nezdařilo',
        deleteSuccess: 'Uživatel smazán',
        deleteFailed: 'Smazání se nezdařilo',
        updateSuccess: 'Aktualizováno',
        updateFailed: 'Aktualizace se nezdařila',
        loadFailed: 'Načtení uživatelů se nezdařilo',
      ...
      audit: {
        ...
        clearConfirmTitle: 'Vymazat celý protokol aktivit?',
        clearConfirmText: 'Tím se trvale odstraní všechny záznamy a nelze to vrátit zpět.',
        clearConfirmOk: 'Vymazat',
        clearConfirmCancel: 'Zrušit',
        clearSuccess: 'Protokol aktivit vymazán',
        clearFailed: 'Protokol se nepodařilo vymazat',
        colTime: 'Čas',
        colUser: 'Uživatel',
        colAction: 'Akce',
        colIp: 'IP',
        ...
        filterUser: 'Filtrovat podle uživatele',
        count: 'Počet záznamů: {{count}}',
        loadFailed: 'Nepodařilo se načíst protokol aktivit',
        enableSuccess: 'Protokol aktivit povolen',
        disableSuccess: 'Protokol aktivit zakázán',
        updateFailed: 'Nepodařilo se aktualizovat nastavení',
        actions: {
          login: 'přihlášení',
          logout: 'odhlášení',
          changePassword: 'změna vlastního hesla',
          createUser: 'vytvořit uživatele',
          updateUser: 'upravit uživatele',
          deleteUser: 'smazat uživatele',
          changeUserPassword: 'změnit heslo uživatele',
          auditConfig: 'změnit nastavení protokolu',
          clearAudit: 'vymazat protokol',
          gpio: 'tlačítko napájení/reset',
          reboot: 'restartovat zařízení',
          usbRecover: 'obnovit USB',
          sshEnable: 'povolit SSH',
          sshDisable: 'zakázat SSH',
          hdmiEnable: 'povolit HDMI',
          hdmiDisable: 'zakázat HDMI',
          hdmiReset: 'resetovat HDMI',
          mdnsEnable: 'povolit mDNS',
          mdnsDisable: 'zakázat mDNS',
          hostname: 'nastavit název hostitele',
          webTitle: 'nastavit název webu',
          tls: 'nastavit TLS',
          oled: 'nastavit OLED',
          swap: 'nastavit swap',
          memoryLimit: 'nastavit limit paměti',
          virtualDevice: 'nastavit virtuální zařízení',
          mouseJiggler: 'nastavit mouse jiggler',
          runScript: 'spustit skript',
          uploadScript: 'nahrát skript',
          deleteScript: 'smazat skript',
          autostartSet: 'nastavit automatické spuštění',
          autostartDelete: 'smazat automatické spuštění',
          terminal: 'otevřít webový terminál',
          hidPaste: 'vložit text',
          hidMode: 'změnit režim HID',
          hidReset: 'resetovat HID',
          shortcutAdd: 'přidat zkratku',
          shortcutDelete: 'smazat zkratku',
          leaderKey: 'nastavit klávesu leader',
          setDns: 'nastavit DNS',
          setIp: 'nastavit IP adresu',
          wifiConnect: 'připojit Wi-Fi',
          wifiDisconnect: 'odpojit Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'nastavit název MAC',
          wolMacDelete: 'smazat MAC',
          imageMount: 'připojit virtuální médium',
          imageDelete: 'smazat obraz',
          imageDownload: 'stáhnout obraz',
          firmwareUpdate: 'aktualizovat firmware',
          firmwareUpdateOffline: 'aktualizovat firmware (offline)',
          firmwarePreview: 'nastavit kanál náhledu',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'spustit Tailscale',
          tsStop: 'zastavit Tailscale',
          tsRestart: 'restartovat Tailscale',
          tsInstall: 'nainstalovat Tailscale',
          tsUninstall: 'odinstalovat Tailscale',
          tsLogin: 'přihlášení Tailscale',
          tsLogout: 'odhlášení Tailscale'
        }
      },
      account: {
        title: 'Účet',
