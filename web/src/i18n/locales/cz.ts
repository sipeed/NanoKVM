  ...
  translation: {
    ...
    settings: {
      ...
      users: {
        ...
        roleOperator: 'Použití KVM: stream, klávesnice, myš, tlačítka napájení',
        roleViewer: 'Pouze zobrazení streamu',
        changePassword: 'Změnit heslo',
        newPassword: 'Nové heslo',
        confirmPassword: 'Potvrďte heslo',
        pwdMismatch: 'Hesla se neshodují',
        pwdSuccess: 'Heslo úspěšně změněno',
        pwdFailed: 'Nepodařilo se změnit heslo',
        password: 'Heslo',
        delete: 'Smazat',
        deleteConfirm: 'Opravdu chcete smazat tohoto uživatele?',
