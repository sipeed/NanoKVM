    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Uloženo. Připojení se nyní přeruší — znovu otevřete NanoKVM na {{url}}',
          warning: 'Změna IP adresy odpojí vaši aktuální relaci. Nesprávná hodnota vás může vyřadit z webového rozhraní (obnovení pak vyžaduje SD kartu/fyzický přístup). Ujistěte se, že adresa, maska a brána jsou správné.',
          confirmTitle: 'Změnit IP adresu?',
          confirmStatic: 'Kabelové připojení se okamžitě překonfiguruje a tato relace se přeruší. Poté otevřete NanoKVM na {{url}}. Pokračovat?',
