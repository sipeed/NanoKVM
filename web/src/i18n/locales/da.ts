    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Gemt. Forbindelsen afbrydes nu — åbn NanoKVM igen på {{url}}',
          warning: 'Ændring af IP-adressen afbryder din nuværende session. En forkert værdi kan låse dig ude af webgrænsefladen (gendannelse kræver så SD-kort/fysisk adgang). Sørg for, at adresse, maske og gateway er korrekte.',
          confirmTitle: 'Skift IP-adresse?',
          confirmStatic: 'Den kablede forbindelse omkonfigureres med det samme, og denne session afbrydes. Åbn derefter NanoKVM på {{url}}. Fortsæt?',
