  ...
  translation: {
    ...
    settings: {
      ...
      users: {
        ...
        rolesTitle: 'Rolleoversigt',
        roleAdmin: 'Fuld adgang + brugeradministration',
        roleOperator: 'KVM-brug: stream, tastatur, mus, tænd-knapper',
        roleViewer: 'Kun stream-visning',
        changePassword: 'Skift adgangskode',
        newPassword: 'Ny adgangskode',
        confirmPassword: 'Bekræft adgangskode',
        pwdMismatch: 'Adgangskoder stemmer ikke overens',
        pwdSuccess: 'Adgangskode ændret',
        pwdFailed: 'Kunne ikke ændre adgangskode',
