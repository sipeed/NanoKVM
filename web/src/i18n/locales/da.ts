  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP-adresse',
          description: 'Konfigurer den kablede forbindelse (eth0)',
          dhcp: 'DHCP',
          static: 'Manuel',
          addressing: 'IPv4-konfiguration',
          dhcpDescription: 'IP-adressen hentes automatisk via DHCP',
          staticDescription: 'Angiv en fast IP-adresse, undernetmaske og gateway',
          ipAddress: 'IP-adresse',
          subnetMask: 'Undernetmaske',
          gateway: 'Gateway',
          save: 'Gem',
          ...
          invalidMask: 'Indtast en gyldig undernetmaske',
          invalidGateway: 'Indtast en gyldig gateway-adresse',
          gatewaySubnet: 'Gateway skal være i samme undernet som IP-adressen',
          saveFailed: 'IP-indstillingerne kunne ikke gemmes',
          savedDhcp: 'Skiftet til DHCP. IP-adressen kan snart ændre sig.',
          savedReconnect: 'Gemt. Forbindelsen afbrydes nu — åbn NanoKVM igen på {{url}} og bekræft der inden for 5 minutter, ellers nulstilles det.',
          confirmPendingTitle: 'Bekræft ny IP-adresse',
          confirmPendingText: 'Vender tilbage til den tidligere konfiguration om {{time}}, hvis du ikke bekræfter.',
          confirmKeep: 'Behold konfiguration',
          confirmed: 'IP-konfiguration bekræftet',
          confirmFailed: 'Bekræftelse mislykkedes',
          reverted: 'Ikke bekræftet — vendt tilbage til den tidligere konfiguration',
          warning: 'Ændring af IP-adressen afbryder denne session. Derefter har du 5 minutter til at oprette forbindelse igen på den nye adresse og bekræfte; ellers vender enheden automatisk tilbage til den tidligere konfiguration. Sørg for, at adresse, maske og gateway er korrekte.',
          confirmTitle: 'Skift IP-adresse?',
          confirmStatic: 'Den kablede forbindelse omkonfigureres med det samme, og denne session afbrydes. Opret forbindelse igen på {{url}} og bekræft inden for 5 minutter, ellers nulstilles det automatisk. Fortsæt?',
          confirmDhcp: 'Den kablede forbindelse skifter straks til DHCP, og denne session kan blive afbrudt. Fortsæt?',
          confirmOk: 'Anvend',
      ...
      users: {
        ...
        rolesTitle: 'Oversigt over roller',
        roleAdmin: 'Fuld adgang + brugerstyring',
        roleOperator: 'Brug af KVM: video, tastatur, mus, strømknapper',
        roleViewer: 'Kun se video',
        changePassword: 'Skift adgangskode',
        newPassword: 'Ny adgangskode',
        confirmPassword: 'Bekræft adgangskode',
        pwdMismatch: 'Adgangskoderne stemmer ikke overens',
        pwdSuccess: 'Adgangskode ændret',
        pwdFailed: 'Ændring af adgangskode mislykkedes',
        password: 'Adgangskode',
        delete: 'Slet',
        deleteConfirm: 'Er du sikker på, at du vil slette denne bruger?',
        createSuccess: 'Bruger oprettet',
        createFailed: 'Oprettelse mislykkedes',
        deleteSuccess: 'Bruger slettet',
        deleteFailed: 'Sletning mislykkedes',
        updateSuccess: 'Opdateret',
        updateFailed: 'Opdatering mislykkedes',
        loadFailed: 'Kunne ikke indlæse brugere',
        usernameRequired: 'Indtast brugernavn',
        passwordRequired: 'Indtast adgangskode',
        okBtn: 'OK',
        cancelBtn: 'Annuller'
      },
      audit: {
        ...
        refresh: 'Opdater',
        clearLog: 'Ryd log',
        clearConfirmTitle: 'Ryd hele aktivitetsloggen?',
        clearConfirmText: 'Dette sletter alle logposter permanent og kan ikke fortrydes.',
        clearConfirmOk: 'Ryd',
        clearConfirmCancel: 'Annuller',
        clearSuccess: 'Aktivitetslog ryddet',
        clearFailed: 'Aktivitetsloggen kunne ikke ryddes',
        colTime: 'Tid',
        colUser: 'Bruger',
        colAction: 'Handling',
        colIp: 'IP',
        ...
        filterUser: 'Filtrer efter bruger',
        count: '{{count}} poster',
        loadFailed: 'Kunne ikke indlæse aktivitetsloggen',
        enableSuccess: 'Aktivitetslog aktiveret',
        disableSuccess: 'Aktivitetslog deaktiveret',
        updateFailed: 'Kunne ikke opdatere indstillingen',
        actions: {
          login: 'login',
          logout: 'logud',
          changePassword: 'skift egen adgangskode',
          createUser: 'opret bruger',
          updateUser: 'opdater bruger',
          deleteUser: 'slet bruger',
          changeUserPassword: 'skift brugerens adgangskode',
          auditConfig: 'skift logindstillinger',
          clearAudit: 'ryd log',
          gpio: 'tænd/reset-knap',
          reboot: 'genstart enhed',
          usbRecover: 'gendan USB',
          sshEnable: 'aktivér SSH',
          sshDisable: 'deaktivér SSH',
          hdmiEnable: 'aktivér HDMI',
          hdmiDisable: 'deaktivér HDMI',
          hdmiReset: 'nulstil HDMI',
          mdnsEnable: 'aktivér mDNS',
          mdnsDisable: 'deaktivér mDNS',
          hostname: 'angiv værtsnavn',
          webTitle: 'angiv webtitel',
          tls: 'konfigurer TLS',
          oled: 'konfigurer OLED',
          swap: 'konfigurer swap',
          memoryLimit: 'angiv hukommelsesgrænse',
          virtualDevice: 'konfigurer virtuel enhed',
          mouseJiggler: 'angiv mouse jiggler',
          runScript: 'kør script',
          uploadScript: 'upload script',
          deleteScript: 'slet script',
          autostartSet: 'angiv autostart',
          autostartDelete: 'slet autostart',
          terminal: 'åbn webterminal',
          hidPaste: 'indsæt tekst',
          hidMode: 'skift HID-tilstand',
          hidReset: 'nulstil HID',
          shortcutAdd: 'tilføj genvej',
          shortcutDelete: 'slet genvej',
          leaderKey: 'angiv leader-tast',
          setDns: 'angiv DNS',
          setIp: 'angiv IP-adresse',
          wifiConnect: 'forbind Wi-Fi',
          wifiDisconnect: 'afbryd Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'angiv MAC-navn',
          wolMacDelete: 'slet MAC',
          imageMount: 'montér virtuelt medie',
          imageDelete: 'slet image',
          imageDownload: 'download image',
          firmwareUpdate: 'opdater firmware',
          firmwareUpdateOffline: 'opdater firmware (offline)',
          firmwarePreview: 'angiv preview-kanal',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'start Tailscale',
          tsStop: 'stop Tailscale',
          tsRestart: 'genstart Tailscale',
          tsInstall: 'installer Tailscale',
          tsUninstall: 'afinstaller Tailscale',
          tsLogin: 'Tailscale-login',
          tsLogout: 'Tailscale-logud'
        }
      },
      account: {
        title: 'Konto',
