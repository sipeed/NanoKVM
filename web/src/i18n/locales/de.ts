  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP-Adresse',
          description: 'Kabelverbindung (eth0) konfigurieren',
          dhcp: 'DHCP',
          static: 'Manuell',
          addressing: 'IPv4-Konfiguration',
          dhcpDescription: 'IP-Adresse wird automatisch per DHCP bezogen',
          staticDescription: 'Feste IP-Adresse, Subnetzmaske und Gateway festlegen',
          ipAddress: 'IP-Adresse',
          subnetMask: 'Subnetzmaske',
          gateway: 'Gateway',
          save: 'Speichern',
          ...
          invalidMask: 'Bitte geben Sie eine gültige Subnetzmaske ein',
          invalidGateway: 'Bitte geben Sie eine gültige Gateway-Adresse ein',
      ...
      audit: {
        ...
        clearConfirmTitle: 'Gesamten Verlauf löschen?',
        clearConfirmText: 'Dadurch werden alle Protokolleinträge dauerhaft gelöscht. Das kann nicht rückgängig gemacht werden.',
        clearConfirmOk: 'Löschen',
        clearConfirmCancel: 'Abbrechen',
        clearSuccess: 'Aktivitätsprotokoll geleert',
        clearFailed: 'Aktivitätsprotokoll konnte nicht geleert werden',
        colTime: 'Zeit',
        colUser: 'Benutzer',
        colAction: 'Aktion',
        colIp: 'IP',
        ...
        enableSuccess: 'Aktivitätsprotokoll aktiviert',
        disableSuccess: 'Aktivitätsprotokoll deaktiviert',
        updateFailed: 'Einstellung konnte nicht geändert werden',
        actions: {
          login: 'Anmeldung',
          logout: 'Abmeldung',
          changePassword: 'eigenes Passwort ändern',
          createUser: 'Benutzer erstellen',
          updateUser: 'Benutzer ändern',
          deleteUser: 'Benutzer löschen',
          changeUserPassword: 'Benutzer-Passwort ändern',
          auditConfig: 'Protokoll-Einstellung ändern',
          clearAudit: 'Protokoll löschen',
          gpio: 'Power-/Reset-Taste',
          reboot: 'Gerät neu starten',
          usbRecover: 'USB wiederherstellen',
          sshEnable: 'SSH aktivieren',
          sshDisable: 'SSH deaktivieren',
          hdmiEnable: 'HDMI aktivieren',
          hdmiDisable: 'HDMI deaktivieren',
          hdmiReset: 'HDMI zurücksetzen',
          mdnsEnable: 'mDNS aktivieren',
          mdnsDisable: 'mDNS deaktivieren',
          hostname: 'Hostname setzen',
          webTitle: 'Web-Titel setzen',
          tls: 'TLS konfigurieren',
          oled: 'OLED konfigurieren',
          swap: 'Swap konfigurieren',
          memoryLimit: 'Speicherlimit setzen',
          virtualDevice: 'virtuelles Gerät konfigurieren',
          mouseJiggler: 'Maus-Jiggler setzen',
          runScript: 'Skript ausführen',
          uploadScript: 'Skript hochladen',
          deleteScript: 'Skript löschen',
          autostartSet: 'Autostart setzen',
          autostartDelete: 'Autostart löschen',
          terminal: 'Web-Terminal öffnen',
          hidPaste: 'Text einfügen',
          hidMode: 'HID-Modus ändern',
          hidReset: 'HID zurücksetzen',
          shortcutAdd: 'Kürzel hinzufügen',
          shortcutDelete: 'Kürzel löschen',
          leaderKey: 'Kürzel-Leader-Taste setzen',
          setDns: 'DNS setzen',
          setIp: 'IP-Adresse setzen',
          wifiConnect: 'WLAN verbinden',
          wifiDisconnect: 'WLAN trennen',
          wol: 'Wake-on-LAN',
          wolMacName: 'MAC-Name setzen',
          wolMacDelete: 'MAC löschen',
          imageMount: 'virtuelles Medium einbinden',
          imageDelete: 'Image löschen',
          imageDownload: 'Image herunterladen',
          firmwareUpdate: 'Firmware aktualisieren',
          firmwareUpdateOffline: 'Firmware aktualisieren (offline)',
          firmwarePreview: 'Vorschau-Kanal setzen',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'Tailscale starten',
          tsStop: 'Tailscale stoppen',
          tsRestart: 'Tailscale neu starten',
          tsInstall: 'Tailscale installieren',
          tsUninstall: 'Tailscale deinstallieren',
          tsLogin: 'Tailscale-Anmeldung',
          tsLogout: 'Tailscale-Abmeldung'
        }
      },
      account: {
        title: 'Konto',
