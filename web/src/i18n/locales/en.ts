  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP Address',
          description: 'Configure the wired connection (eth0)',
          dhcp: 'DHCP',
          static: 'Manual',
          addressing: 'IPv4 Configuration',
          dhcpDescription: 'IP address is automatically obtained from DHCP',
          staticDescription: 'Set a fixed IP address, subnet mask and gateway',
          ipAddress: 'IP Address',
          subnetMask: 'Subnet Mask',
          gateway: 'Gateway',
          save: 'Save',
          ...
          invalidMask: 'Please enter a valid subnet mask',
          invalidGateway: 'Please enter a valid gateway address',
      ...
      users: {
        ...
        colEnabled: 'Enabled',
        colActions: 'Actions',
        rolesTitle: 'Role Overview',
        roleAdmin: 'Full access + user management',
        roleOperator: 'KVM control: stream, keyboard, mouse, power buttons',
        roleViewer: 'View-only: watch stream',
        changePassword: 'Change Password',
      ...
      audit: {
        ...
        refresh: 'Refresh',
        clearLog: 'Clear log',
        clearConfirmTitle: 'Clear entire activity log?',
        clearConfirmText: 'This permanently deletes all log entries and cannot be undone.',
        clearConfirmOk: 'Clear',
        clearConfirmCancel: 'Cancel',
        clearSuccess: 'Activity log cleared',
        clearFailed: 'Failed to clear activity log',
        colTime: 'Time',
        colUser: 'User',
        colAction: 'Action',
        colIp: 'IP',
        ...
        enableSuccess: 'Activity log enabled',
        disableSuccess: 'Activity log disabled',
        ...
        actions: {
          ...
          auditConfig: 'change audit settings',
          clearAudit: 'clear log',
          gpio: 'power / reset button',
          reboot: 'reboot device',
          usbRecover: 'recover USB',
          sshEnable: 'enable SSH',
          sshDisable: 'disable SSH',
          hdmiEnable: 'enable HDMI',
          hdmiDisable: 'disable HDMI',
          hdmiReset: 'reset HDMI',
          mdnsEnable: 'enable mDNS',
          mdnsDisable: 'disable mDNS',
          hostname: 'set hostname',
          webTitle: 'set web title',
          tls: 'configure TLS',
          oled: 'configure OLED',
          swap: 'configure swap',
          memoryLimit: 'set memory limit',
          virtualDevice: 'configure virtual device',
          mouseJiggler: 'set mouse jiggler',
          runScript: 'run script',
          uploadScript: 'upload script',
          deleteScript: 'delete script',
          autostartSet: 'set autostart',
          autostartDelete: 'delete autostart',
          terminal: 'open web terminal',
          hidPaste: 'paste text',
          hidMode: 'change HID mode',
          hidReset: 'reset HID',
          shortcutAdd: 'add shortcut',
          shortcutDelete: 'delete shortcut',
          leaderKey: 'set shortcut leader key',
          setDns: 'set DNS',
          setIp: 'set IP address',
          wifiConnect: 'connect Wi-Fi',
          wifiDisconnect: 'disconnect Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'set MAC name',
          wolMacDelete: 'delete MAC',
          imageMount: 'mount virtual media',
          imageDelete: 'delete image',
          imageDownload: 'download image',
          firmwareUpdate: 'update firmware',
          firmwareUpdateOffline: 'update firmware (offline)',
          firmwarePreview: 'set preview channel',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'start Tailscale',
          tsStop: 'stop Tailscale',
          tsRestart: 'restart Tailscale',
          tsInstall: 'install Tailscale',
          tsUninstall: 'uninstall Tailscale',
          tsLogin: 'Tailscale login',
          tsLogout: 'Tailscale logout'
        }
      },
      account: {
        title: 'Account',
