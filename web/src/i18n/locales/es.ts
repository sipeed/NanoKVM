  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'Dirección IP',
          description: 'Configura la conexión por cable (eth0)',
          dhcp: 'DHCP',
          static: 'Manual',
          addressing: 'Configuración IPv4',
          dhcpDescription: 'La dirección IP se obtiene automáticamente por DHCP',
          staticDescription: 'Establece una dirección IP fija, máscara de subred y puerta de enlace',
          ipAddress: 'Dirección IP',
          subnetMask: 'Máscara de subred',
          gateway: 'Puerta de enlace',
          save: 'Guardar',
          unsaved: 'Cambios sin guardar',
          invalidAddress: 'Introduce una dirección IP válida',
          invalidMask: 'Introduce una máscara de subred válida',
          invalidGateway: 'Introduce una dirección de puerta de enlace válida',
          gatewaySubnet: 'La puerta de enlace debe estar en la misma subred que la dirección IP',
          saveFailed: 'No se pudieron guardar los ajustes de IP',
          savedDhcp: 'Se cambió a DHCP. La dirección IP puede cambiar en breve.',
          savedReconnect: 'Guardado. La conexión se cerrará ahora — vuelve a abrir NanoKVM en {{url}} y confírmalo allí en 5 minutos, de lo contrario se revertirá.',
          confirmPendingTitle: 'Confirmar la nueva dirección IP',
          confirmPendingText: 'Se volverá a la configuración anterior en {{time}} si no confirmas.',
          confirmKeep: 'Mantener configuración',
          confirmed: 'Configuración IP confirmada',
          confirmFailed: 'Error en la confirmación',
          reverted: 'No confirmado — se volvió a la configuración anterior',
          warning: 'Cambiar la dirección IP desconecta esta sesión. Después tienes 5 minutos para volver a conectarte a la nueva dirección y confirmarla; de lo contrario, el dispositivo volverá automáticamente a la configuración anterior. Asegúrate de que la dirección, la máscara y la puerta de enlace sean correctas.',
          confirmTitle: '¿Cambiar la dirección IP?',
          confirmStatic: 'La conexión por cable se reconfigurará de inmediato y esta sesión se cerrará. Vuelve a conectarte en {{url}} y confirma en 5 minutos, de lo contrario se revertirá automáticamente. ¿Continuar?',
          confirmDhcp: 'La conexión por cable cambiará a DHCP de inmediato y esta sesión podría cerrarse. ¿Continuar?',
          confirmOk: 'Aplicar',
      ...
      users: {
        ...
        roleOperator: 'Uso del KVM: vídeo, teclado, ratón, botones de energía',
        roleViewer: 'Solo ver vídeo',
        changePassword: 'Cambiar contraseña',
        ...
        password: 'Contraseña',
        delete: 'Eliminar',
        deleteConfirm: '¿Seguro que quiere eliminar este usuario?',
        ...
        usernameRequired: 'Introduzca un nombre de usuario',
        passwordRequired: 'Introduzca una contraseña',
        okBtn: 'Aceptar',
        cancelBtn: 'Cancelar'
      },
      audit: {
        ...
        clearConfirmTitle: '¿Borrar todo el registro de actividad?',
        clearConfirmText: 'Esto elimina permanentemente todas las entradas y no se puede deshacer.',
        clearConfirmOk: 'Borrar',
        clearConfirmCancel: 'Cancelar',
        clearSuccess: 'Registro de actividad borrado',
        clearFailed: 'No se pudo borrar el registro',
        colTime: 'Hora',
        colUser: 'Usuario',
        colAction: 'Acción',
        colIp: 'IP',
        ...
        enableSuccess: 'Registro de actividad activado',
        disableSuccess: 'Registro de actividad desactivado',
        ...
        actions: {
          ...
          auditConfig: 'cambiar ajustes del registro',
          clearAudit: 'borrar registro',
          gpio: 'botón encendido/reinicio',
          reboot: 'reiniciar dispositivo',
          usbRecover: 'recuperar USB',
          sshEnable: 'activar SSH',
          sshDisable: 'desactivar SSH',
          hdmiEnable: 'activar HDMI',
          hdmiDisable: 'desactivar HDMI',
          hdmiReset: 'restablecer HDMI',
          mdnsEnable: 'activar mDNS',
          mdnsDisable: 'desactivar mDNS',
          hostname: 'definir nombre de host',
          webTitle: 'definir título web',
          tls: 'configurar TLS',
          oled: 'configurar OLED',
          swap: 'configurar swap',
          memoryLimit: 'definir límite de memoria',
          virtualDevice: 'configurar dispositivo virtual',
          mouseJiggler: 'definir mouse jiggler',
          runScript: 'ejecutar script',
          uploadScript: 'subir script',
          deleteScript: 'eliminar script',
          autostartSet: 'definir autoarranque',
          autostartDelete: 'eliminar autoarranque',
          terminal: 'abrir terminal web',
          hidPaste: 'pegar texto',
          hidMode: 'cambiar modo HID',
          hidReset: 'restablecer HID',
          shortcutAdd: 'añadir atajo',
          shortcutDelete: 'eliminar atajo',
          leaderKey: 'definir tecla líder',
          setDns: 'definir DNS',
          setIp: 'definir dirección IP',
          wifiConnect: 'conectar Wi-Fi',
          wifiDisconnect: 'desconectar Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'definir nombre MAC',
          wolMacDelete: 'eliminar MAC',
          imageMount: 'montar medio virtual',
          imageDelete: 'eliminar imagen',
          imageDownload: 'descargar imagen',
          firmwareUpdate: 'actualizar firmware',
          firmwareUpdateOffline: 'actualizar firmware (offline)',
          firmwarePreview: 'definir canal de vista previa',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'iniciar Tailscale',
          tsStop: 'detener Tailscale',
          tsRestart: 'reiniciar Tailscale',
          tsInstall: 'instalar Tailscale',
          tsUninstall: 'desinstalar Tailscale',
          tsLogin: 'iniciar sesión Tailscale',
          tsLogout: 'cerrar sesión Tailscale'
        }
      },
      account: {
        title: 'Cuenta',
