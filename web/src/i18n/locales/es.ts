    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Guardado. La conexión se cerrará ahora — vuelve a abrir NanoKVM en {{url}}',
          warning: 'Cambiar la dirección IP desconecta la sesión actual. Un valor incorrecto puede bloquear el acceso a la interfaz web (la recuperación requiere tarjeta SD/acceso físico). Asegúrate de que la dirección, la máscara y la puerta de enlace sean correctas.',
          confirmTitle: '¿Cambiar la dirección IP?',
          confirmStatic: 'La conexión por cable se reconfigurará de inmediato y esta sesión se cerrará. Después abre NanoKVM en {{url}}. ¿Continuar?',
