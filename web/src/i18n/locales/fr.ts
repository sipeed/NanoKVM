  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'Adresse IP',
          description: 'Configurer la connexion filaire (eth0)',
          dhcp: 'DHCP',
          static: 'Manuel',
          addressing: 'Configuration IPv4',
          dhcpDescription: "L'adresse IP est obtenue automatiquement par DHCP",
          staticDescription: 'Définir une adresse IP fixe, un masque de sous-réseau et une passerelle',
          ipAddress: 'Adresse IP',
          subnetMask: 'Masque de sous-réseau',
          gateway: 'Passerelle',
          save: 'Enregistrer',
          ...
          invalidMask: 'Veuillez saisir un masque de sous-réseau valide',
          invalidGateway: 'Veuillez saisir une adresse de passerelle valide',
          gatewaySubnet: "La passerelle doit être dans le même sous-réseau que l'adresse IP",
          saveFailed: "Échec de l'enregistrement des paramètres IP",
          savedDhcp: "Basculé sur DHCP. L'adresse IP peut changer sous peu.",
          savedReconnect: 'Enregistré. La connexion va se couper — rouvrez NanoKVM à {{url}} et confirmez-y dans les 5 minutes, sinon le réglage sera annulé.',
          confirmPendingTitle: 'Confirmer la nouvelle adresse IP',
          confirmPendingText: 'Retour à la configuration précédente dans {{time}} si vous ne confirmez pas.',
          confirmKeep: 'Conserver la configuration',
          confirmed: 'Configuration IP confirmée',
          confirmFailed: 'Échec de la confirmation',
          reverted: 'Non confirmé — retour à la configuration précédente',
          warning: "Modifier l'adresse IP déconnecte cette session. Vous avez ensuite 5 minutes pour vous reconnecter à la nouvelle adresse et la confirmer ; sinon l'appareil revient automatiquement à la configuration précédente. Vérifiez que l'adresse, le masque et la passerelle sont corrects.",
          confirmTitle: "Modifier l'adresse IP ?",
          confirmStatic: 'La connexion filaire va être reconfigurée immédiatement et cette session sera interrompue. Reconnectez-vous à {{url}} et confirmez dans les 5 minutes, sinon le réglage est annulé automatiquement. Continuer ?',
          confirmDhcp: 'La connexion filaire va basculer sur DHCP immédiatement et cette session peut être interrompue. Continuer ?',
          confirmOk: 'Appliquer',
      ...
      users: {
        ...
        roleOperator: "Utilisation du KVM : vidéo, clavier, souris, boutons d'alimentation",
        roleViewer: 'Visualisation vidéo uniquement',
        changePassword: 'Changer le mot de passe',
      ...
      audit: {
        ...
        clearConfirmTitle: "Effacer tout le journal d'activité ?",
        clearConfirmText: 'Cela supprime définitivement toutes les entrées et est irréversible.',
        clearConfirmOk: 'Effacer',
        clearConfirmCancel: 'Annuler',
        clearSuccess: "Journal d'activité effacé",
        clearFailed: "Échec de l'effacement du journal",
        colTime: 'Heure',
        colUser: 'Utilisateur',
        colAction: 'Action',
        colIp: 'IP',
        ...
        count: '{{count}} entrées',
        loadFailed: 'Échec du chargement du journal d\'activité',
        enableSuccess: 'Journal d\'activité activé',
        disableSuccess: 'Journal d\'activité désactivé',
        ...
        actions: {
          ...
          auditConfig: 'modifier les réglages du journal',
          clearAudit: 'effacer le journal',
          gpio: 'bouton marche/redémarrage',
          reboot: 'redémarrer l\'appareil',
          usbRecover: 'récupérer l\'USB',
          sshEnable: 'activer SSH',
          sshDisable: 'désactiver SSH',
          hdmiEnable: 'activer HDMI',
          hdmiDisable: 'désactiver HDMI',
          hdmiReset: 'réinitialiser HDMI',
          mdnsEnable: 'activer mDNS',
          mdnsDisable: 'désactiver mDNS',
          hostname: 'définir le nom d\'hôte',
          webTitle: 'définir le titre web',
          tls: 'configurer TLS',
          oled: 'configurer OLED',
          swap: 'configurer le swap',
          memoryLimit: 'définir la limite mémoire',
          virtualDevice: 'configurer le périphérique virtuel',
          mouseJiggler: 'définir le mouse jiggler',
          runScript: 'exécuter le script',
          uploadScript: 'téléverser un script',
          deleteScript: 'supprimer le script',
          autostartSet: 'définir le démarrage auto',
          autostartDelete: 'supprimer le démarrage auto',
          terminal: 'ouvrir le terminal web',
          hidPaste: 'coller du texte',
          hidMode: 'changer le mode HID',
          hidReset: 'réinitialiser HID',
          shortcutAdd: 'ajouter un raccourci',
          shortcutDelete: 'supprimer un raccourci',
          leaderKey: 'définir la touche leader',
          setDns: 'définir le DNS',
          setIp: "définir l'adresse IP",
          wifiConnect: 'connecter le Wi-Fi',
          wifiDisconnect: 'déconnecter le Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'définir le nom MAC',
          wolMacDelete: 'supprimer la MAC',
          imageMount: 'monter un média virtuel',
          imageDelete: 'supprimer l\'image',
          imageDownload: 'télécharger l\'image',
          firmwareUpdate: 'mettre à jour le firmware',
          firmwareUpdateOffline: 'mettre à jour le firmware (hors ligne)',
          firmwarePreview: 'définir le canal d\'aperçu',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'démarrer Tailscale',
          tsStop: 'arrêter Tailscale',
          tsRestart: 'redémarrer Tailscale',
          tsInstall: 'installer Tailscale',
          tsUninstall: 'désinstaller Tailscale',
          tsLogin: 'connexion Tailscale',
          tsLogout: 'déconnexion Tailscale'
        }
      },
      account: {
        title: 'Compte',
