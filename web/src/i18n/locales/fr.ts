    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: "Enregistré. La connexion va se couper — rouvrez NanoKVM à l'adresse {{url}}",
          warning: "Modifier l'adresse IP déconnecte votre session actuelle. Une valeur incorrecte peut vous bloquer hors de l'interface web (la récupération nécessite alors la carte SD/un accès physique). Vérifiez que l'adresse, le masque et la passerelle sont corrects.",
          confirmTitle: "Modifier l'adresse IP ?",
          confirmStatic: "La connexion filaire va être reconfigurée immédiatement et cette session sera interrompue. Ouvrez ensuite NanoKVM à l'adresse {{url}}. Continuer ?",
