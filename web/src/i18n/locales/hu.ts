const hu = {
    translation: {
      ...
      updatingLib: 'A futási könyvtár frissítése folyamatban. Kérem, frissítse az oldalt a frissítés után.',
      ...
      auth: {
        ...
        noAccount: 'Nem sikerült megszerezni a felhasználói információkat, frissítse az oldalt vagy állítsa vissza a jelszót',
      ...
      mouse: {
        ...
        requestPointer: 'Relatív mód használata. Kattintson az asztalra, hogy megjelenjen az egérmutató.',
      ...
      tailscale: {
        ...
        notLogin: 'Az eszköz még nincs kötve. Kérem, jelentkezzen be és kösse az eszközt a fiókjához.',
