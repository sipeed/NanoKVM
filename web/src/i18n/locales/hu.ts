    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Mentve. A kapcsolat most megszakad — nyissa meg újra a NanoKVM-et itt: {{url}}',
          warning: 'Az IP-cím módosítása megszakítja az aktuális munkamenetet. A hibás érték kizárhatja a webes felületről (a helyreállításhoz ekkor SD-kártya/fizikai hozzáférés szükséges). Győződjön meg róla, hogy a cím, a maszk és az átjáró helyes.',
          confirmTitle: 'Módosítja az IP-címet?',
          confirmStatic: 'A vezetékes kapcsolat azonnal újrakonfigurálódik, és ez a munkamenet megszakad. Ezután nyissa meg a NanoKVM-et itt: {{url}}. Folytatja?',
