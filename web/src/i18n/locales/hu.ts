  ...
  translation: {
    ...
    settings: {
      ...
      users: {
        ...
        rolesTitle: 'Szerepkörök áttekintése',
        roleAdmin: 'Teljes hozzáférés + felhasználókezelés',
        roleOperator: 'KVM használata: stream, billentyűzet, egér, bekapcsoló gombok',
        roleViewer: 'Csak stream megtekintés',
        changePassword: 'Jelszó módosítása',
        newPassword: 'Új jelszó',
        confirmPassword: 'Jelszó megerősítése',
        pwdMismatch: 'A jelszavak nem egyeznek',
        pwdSuccess: 'Jelszó sikeresen módosítva',
        pwdFailed: 'Jelszó módosítása sikertelen',
        password: 'Jelszó',
        delete: 'Törlés',
        deleteConfirm: 'Biztosan törölni szeretné ezt a felhasználót?',
        ...
        loadFailed: 'Felhasználók betöltése sikertelen',
