  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP-cím',
          description: 'A vezetékes kapcsolat beállítása (eth0)',
          dhcp: 'DHCP',
          static: 'Kézi',
          addressing: 'IPv4-konfiguráció',
          dhcpDescription: 'Az IP-címet a rendszer automatikusan kapja DHCP-n keresztül',
          staticDescription: 'Állítson be rögzített IP-címet, alhálózati maszkot és átjárót',
          ipAddress: 'IP-cím',
          subnetMask: 'Alhálózati maszk',
          gateway: 'Átjáró',
          save: 'Mentés',
          ...
          invalidMask: 'Adjon meg egy érvényes alhálózati maszkot',
          invalidGateway: 'Adjon meg egy érvényes átjárócímet',
          gatewaySubnet: 'Az átjárónak ugyanabban az alhálózatban kell lennie, mint az IP-címnek',
          saveFailed: 'Az IP-beállítások mentése nem sikerült',
          savedDhcp: 'Átváltva DHCP-re. Az IP-cím hamarosan megváltozhat.',
          savedReconnect: 'Mentve. A kapcsolat most megszakad — nyissa meg újra a NanoKVM-et itt: {{url}}, és erősítse meg ott 5 percen belül, különben visszaáll.',
          confirmPendingTitle: 'Új IP-cím megerősítése',
          confirmPendingText: 'Visszaállás az előző konfigurációra {{time}} múlva, ha nem erősíti meg.',
          confirmKeep: 'Konfiguráció megtartása',
          confirmed: 'IP-konfiguráció megerősítve',
          confirmFailed: 'A megerősítés nem sikerült',
          reverted: 'Nincs megerősítve — visszaállt az előző konfigurációra',
          warning: 'Az IP-cím módosítása megszakítja ezt a munkamenetet. Ezután 5 perce van újracsatlakozni az új címen és megerősíteni; különben az eszköz automatikusan visszaáll az előző konfigurációra. Győződjön meg róla, hogy a cím, a maszk és az átjáró helyes.',
          confirmTitle: 'Módosítja az IP-címet?',
          confirmStatic: 'A vezetékes kapcsolat azonnal újrakonfigurálódik, és ez a munkamenet megszakad. Csatlakozzon újra itt: {{url}}, és erősítse meg 5 percen belül, különben automatikusan visszaáll. Folytatja?',
          confirmDhcp: 'A vezetékes kapcsolat azonnal DHCP-re vált, és ez a munkamenet megszakadhat. Folytatja?',
          confirmOk: 'Alkalmaz',
          confirmCancel: 'Mégse'
        }
      },
      ...
      users: {
        ...
        rolesTitle: 'Szerepkör áttekintés',
        roleAdmin: 'Teljes hozzáférés + felhasználókezelés',
        roleOperator: 'KVM használata: kép, billentyűzet, egér, tápgombok',
        roleViewer: 'Csak képnézés',
        changePassword: 'Jelszó módosítása',
        newPassword: 'Új jelszó',
        confirmPassword: 'Jelszó megerősítése',
        pwdMismatch: 'A jelszavak nem egyeznek',
        pwdSuccess: 'Jelszó sikeresen módosítva',
        pwdFailed: 'A jelszó módosítása nem sikerült',
        password: 'Jelszó',
        delete: 'Törlés',
        deleteConfirm: 'Biztos törli ezt a felhasználót?',
        createSuccess: 'Felhasználó létrehozva',
        createFailed: 'A létrehozás nem sikerült',
        deleteSuccess: 'Felhasználó törölve',
        deleteFailed: 'A törlés nem sikerült',
        updateSuccess: 'Frissítve',
        updateFailed: 'A frissítés nem sikerült',
        loadFailed: 'A felhasználók betöltése nem sikerült',
        usernameRequired: 'Adjon meg felhasználónevet',
        passwordRequired: 'Adjon meg jelszót',
        okBtn: 'Ok',
        cancelBtn: 'Mégse'
      },
      audit: {
        ...
        clearConfirmTitle: 'Teljes tevékenységnapló törlése?',
        clearConfirmText: 'Ezzel véglegesen törlődik minden bejegyzés, és nem vonható vissza.',
        clearConfirmOk: 'Törlés',
        clearConfirmCancel: 'Mégse',
        clearSuccess: 'Tevékenységnapló törölve',
        clearFailed: 'A napló törlése nem sikerült',
        colTime: 'Idő',
        colUser: 'Felhasználó',
        colAction: 'Művelet',
        colIp: 'IP',
        ...
        filterUser: 'Szűrés felhasználó szerint',
        count: '{{count}} bejegyzés',
        loadFailed: 'A tevékenységnapló betöltése sikertelen',
        enableSuccess: 'Tevékenységnapló engedélyezve',
        disableSuccess: 'Tevékenységnapló letiltva',
        updateFailed: 'A beállítás módosítása sikertelen',
        actions: {
          login: 'bejelentkezés',
          logout: 'kijelentkezés',
          changePassword: 'saját jelszó módosítása',
          createUser: 'felhasználó létrehozása',
          updateUser: 'felhasználó módosítása',
          deleteUser: 'felhasználó törlése',
          changeUserPassword: 'felhasználó jelszavának módosítása',
          auditConfig: 'naplóbeállítások módosítása',
          clearAudit: 'napló törlése',
          gpio: 'bekapcsoló/reset gomb',
          reboot: 'eszköz újraindítása',
          usbRecover: 'USB helyreállítása',
          sshEnable: 'SSH engedélyezése',
          sshDisable: 'SSH letiltása',
          hdmiEnable: 'HDMI engedélyezése',
          hdmiDisable: 'HDMI letiltása',
          hdmiReset: 'HDMI visszaállítása',
          mdnsEnable: 'mDNS engedélyezése',
          mdnsDisable: 'mDNS letiltása',
          hostname: 'gépnév beállítása',
          webTitle: 'webcím beállítása',
          tls: 'TLS beállítása',
          oled: 'OLED beállítása',
          swap: 'swap beállítása',
          memoryLimit: 'memóriakorlát beállítása',
          virtualDevice: 'virtuális eszköz beállítása',
          mouseJiggler: 'mouse jiggler beállítása',
          runScript: 'szkript futtatása',
          uploadScript: 'szkript feltöltése',
          deleteScript: 'szkript törlése',
          autostartSet: 'automatikus indítás beállítása',
          autostartDelete: 'automatikus indítás törlése',
          terminal: 'webterminál megnyitása',
          hidPaste: 'szöveg beillesztése',
          hidMode: 'HID mód módosítása',
          hidReset: 'HID visszaállítása',
          shortcutAdd: 'gyorsbillentyű hozzáadása',
          shortcutDelete: 'gyorsbillentyű törlése',
          leaderKey: 'leader billentyű beállítása',
          setDns: 'DNS beállítása',
          setIp: 'IP-cím beállítása',
          wifiConnect: 'Wi-Fi csatlakozás',
          wifiDisconnect: 'Wi-Fi leválasztás',
          wol: 'wake on LAN',
          wolMacName: 'MAC-név beállítása',
          wolMacDelete: 'MAC törlése',
          imageMount: 'virtuális adathordozó csatolása',
          imageDelete: 'lemezkép törlése',
          imageDownload: 'lemezkép letöltése',
          firmwareUpdate: 'firmware frissítése',
          firmwareUpdateOffline: 'firmware frissítése (offline)',
          firmwarePreview: 'előnézeti csatorna beállítása',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'Tailscale indítása',
          tsStop: 'Tailscale leállítása',
          tsRestart: 'Tailscale újraindítása',
          tsInstall: 'Tailscale telepítése',
          tsUninstall: 'Tailscale eltávolítása',
          tsLogin: 'Tailscale bejelentkezés',
          tsLogout: 'Tailscale kijelentkezés'
        }
      },
      account: {
        title: 'Fiók',
