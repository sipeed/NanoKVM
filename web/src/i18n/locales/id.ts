    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Tersimpan. Koneksi akan terputus sekarang — buka kembali NanoKVM di {{url}}',
          warning: 'Mengubah alamat IP memutuskan sesi Anda saat ini. Nilai yang salah dapat mengunci Anda dari antarmuka web (pemulihan kemudian memerlukan kartu SD/akses fisik). Pastikan alamat, mask, dan gateway sudah benar.',
          confirmTitle: 'Ubah alamat IP?',
          confirmStatic: 'Koneksi kabel akan langsung dikonfigurasi ulang dan sesi ini akan terputus. Setelah itu buka NanoKVM di {{url}}. Lanjutkan?',
