  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'Alamat IP',
          description: 'Konfigurasikan koneksi kabel (eth0)',
          dhcp: 'DHCP',
          static: 'Manual',
          addressing: 'Konfigurasi IPv4',
          dhcpDescription: 'Alamat IP diperoleh secara otomatis dari DHCP',
          staticDescription: 'Tetapkan alamat IP tetap, subnet mask, dan gateway',
          ipAddress: 'Alamat IP',
          subnetMask: 'Subnet mask',
          gateway: 'Gateway',
          save: 'Simpan',
          ...
          invalidMask: 'Masukkan subnet mask yang valid',
          invalidGateway: 'Masukkan alamat gateway yang valid',
          gatewaySubnet: 'Gateway harus berada di subnet yang sama dengan alamat IP',
          saveFailed: 'Gagal menyimpan pengaturan IP',
          savedDhcp: 'Beralih ke DHCP. Alamat IP mungkin segera berubah.',
          savedReconnect: 'Tersimpan. Koneksi akan terputus sekarang — buka kembali NanoKVM di {{url}} dan konfirmasikan di sana dalam 5 menit, jika tidak akan dikembalikan.',
          confirmPendingTitle: 'Konfirmasi alamat IP baru',
          confirmPendingText: 'Kembali ke konfigurasi sebelumnya dalam {{time}} jika tidak dikonfirmasi.',
          confirmKeep: 'Pertahankan konfigurasi',
          confirmed: 'Konfigurasi IP dikonfirmasi',
          confirmFailed: 'Konfirmasi gagal',
          reverted: 'Tidak dikonfirmasi — kembali ke konfigurasi sebelumnya',
          warning: 'Mengubah alamat IP memutuskan sesi ini. Anda lalu punya 5 menit untuk menyambung kembali ke alamat baru dan mengonfirmasinya; jika tidak, perangkat otomatis kembali ke konfigurasi sebelumnya. Pastikan alamat, mask, dan gateway sudah benar.',
          confirmTitle: 'Ubah alamat IP?',
          confirmStatic: 'Koneksi kabel akan langsung dikonfigurasi ulang dan sesi ini akan terputus. Sambungkan kembali di {{url}} dan konfirmasikan dalam 5 menit, jika tidak akan dikembalikan otomatis. Lanjutkan?',
          confirmDhcp: 'Koneksi kabel akan langsung beralih ke DHCP dan sesi ini mungkin terputus. Lanjutkan?',
          confirmOk: 'Terapkan',
          confirmCancel: 'Batal'
        }
      },
      ...
      users: {
        ...
        colEnabled: 'Aktif',
        colActions: 'Aksi',
        rolesTitle: 'Gambaran peran',
        roleAdmin: 'Akses penuh + manajemen pengguna',
        roleOperator: 'Penggunaan KVM: video, keyboard, mouse, tombol daya',
        roleViewer: 'Hanya melihat video',
      ...
      audit: {
        ...
        refresh: 'Segarkan',
        clearLog: 'Hapus log',
        clearConfirmTitle: 'Hapus seluruh log aktivitas?',
        clearConfirmText: 'Ini menghapus semua entri secara permanen dan tidak dapat dibatalkan.',
        clearConfirmOk: 'Hapus',
        clearConfirmCancel: 'Batal',
        clearSuccess: 'Log aktivitas dihapus',
        clearFailed: 'Gagal menghapus log aktivitas',
        colTime: 'Waktu',
        colUser: 'Pengguna',
        colAction: 'Tindakan',
        colIp: 'IP',
        ...
        filterUser: 'Filter berdasarkan pengguna',
        count: '{{count}} entri',
        loadFailed: 'Gagal memuat log aktivitas',
        enableSuccess: 'Log aktivitas diaktifkan',
        disableSuccess: 'Log aktivitas dinonaktifkan',
        updateFailed: 'Gagal memperbarui pengaturan',
        actions: {
          login: 'masuk',
          logout: 'keluar',
          changePassword: 'ubah kata sandi sendiri',
          createUser: 'buat pengguna',
          updateUser: 'perbarui pengguna',
          deleteUser: 'hapus pengguna',
          changeUserPassword: 'ubah kata sandi pengguna',
          auditConfig: 'ubah pengaturan log',
          clearAudit: 'hapus log',
          gpio: 'tombol daya/reset',
          reboot: 'mulai ulang perangkat',
          usbRecover: 'pulihkan USB',
          sshEnable: 'aktifkan SSH',
          sshDisable: 'nonaktifkan SSH',
          hdmiEnable: 'aktifkan HDMI',
          hdmiDisable: 'nonaktifkan HDMI',
          hdmiReset: 'setel ulang HDMI',
          mdnsEnable: 'aktifkan mDNS',
          mdnsDisable: 'nonaktifkan mDNS',
          hostname: 'atur nama host',
          webTitle: 'atur judul web',
          tls: 'konfigurasi TLS',
          oled: 'konfigurasi OLED',
          swap: 'konfigurasi swap',
          memoryLimit: 'atur batas memori',
          virtualDevice: 'konfigurasi perangkat virtual',
          mouseJiggler: 'atur mouse jiggler',
          runScript: 'jalankan skrip',
          uploadScript: 'unggah skrip',
          deleteScript: 'hapus skrip',
          autostartSet: 'atur mulai otomatis',
          autostartDelete: 'hapus mulai otomatis',
          terminal: 'buka terminal web',
          hidPaste: 'tempel teks',
          hidMode: 'ubah mode HID',
          hidReset: 'setel ulang HID',
          shortcutAdd: 'tambah pintasan',
          shortcutDelete: 'hapus pintasan',
          leaderKey: 'atur tombol leader',
          setDns: 'atur DNS',
          setIp: 'atur alamat IP',
          wifiConnect: 'sambungkan Wi-Fi',
          wifiDisconnect: 'putuskan Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'atur nama MAC',
          wolMacDelete: 'hapus MAC',
          imageMount: 'pasang media virtual',
          imageDelete: 'hapus image',
          imageDownload: 'unduh image',
          firmwareUpdate: 'perbarui firmware',
          firmwareUpdateOffline: 'perbarui firmware (offline)',
          firmwarePreview: 'atur saluran pratinjau',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'mulai Tailscale',
          tsStop: 'hentikan Tailscale',
          tsRestart: 'mulai ulang Tailscale',
          tsInstall: 'pasang Tailscale',
          tsUninstall: 'copot Tailscale',
          tsLogin: 'masuk Tailscale',
          tsLogout: 'keluar Tailscale'
        }
      },
      account: {
        title: 'Akun',
