  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'Indirizzo IP',
          description: 'Configura la connessione cablata (eth0)',
          dhcp: 'DHCP',
          static: 'Manuale',
          addressing: 'Configurazione IPv4',
          dhcpDescription: "L'indirizzo IP viene ottenuto automaticamente tramite DHCP",
          staticDescription: 'Imposta un indirizzo IP fisso, subnet mask e gateway',
          ipAddress: 'Indirizzo IP',
          subnetMask: 'Subnet mask',
          gateway: 'Gateway',
          save: 'Salva',
          ...
          invalidMask: 'Inserisci una subnet mask valida',
          invalidGateway: 'Inserisci un indirizzo gateway valido',
          gatewaySubnet: "Il gateway deve trovarsi nella stessa subnet dell'indirizzo IP",
          saveFailed: 'Impossibile salvare le impostazioni IP',
          savedDhcp: "Passato a DHCP. L'indirizzo IP potrebbe cambiare a breve.",
          savedReconnect: 'Salvato. La connessione si interromperà ora — riapri NanoKVM su {{url}} e conferma lì entro 5 minuti, altrimenti verrà ripristinato.',
          confirmPendingTitle: 'Conferma il nuovo indirizzo IP',
          confirmPendingText: 'Ritorno alla configurazione precedente tra {{time}} se non confermi.',
          confirmKeep: 'Mantieni configurazione',
          confirmed: 'Configurazione IP confermata',
          confirmFailed: 'Conferma non riuscita',
          reverted: 'Non confermato — tornato alla configurazione precedente',
          warning: "La modifica dell'indirizzo IP disconnette questa sessione. Hai poi 5 minuti per riconnetterti al nuovo indirizzo e confermarlo; altrimenti il dispositivo torna automaticamente alla configurazione precedente. Assicurati che indirizzo, maschera e gateway siano corretti.",
          confirmTitle: "Cambiare l'indirizzo IP?",
          confirmStatic: 'La connessione cablata verrà riconfigurata immediatamente e questa sessione verrà interrotta. Riconnettiti su {{url}} e conferma entro 5 minuti, altrimenti verrà ripristinato automaticamente. Continuare?',
          confirmDhcp: 'La connessione cablata passerà subito a DHCP e questa sessione potrebbe interrompersi. Continuare?',
          confirmOk: 'Applica',
      ...
      users: {
        ...
        colEnabled: 'Attivo',
        colActions: 'Azioni',
        rolesTitle: 'Panoramica dei ruoli',
        roleAdmin: 'Accesso completo + gestione utenti',
        roleOperator: 'Uso del KVM: video, tastiera, mouse, pulsanti di alimentazione',
        roleViewer: 'Solo visualizzazione video',
        changePassword: 'Cambia password',
        newPassword: 'Nuova password',
        confirmPassword: 'Conferma password',
        pwdMismatch: 'Le password non corrispondono',
        pwdSuccess: 'Password modificata con successo',
        pwdFailed: 'Modifica della password non riuscita',
        password: 'Password',
        delete: 'Elimina',
      ...
      audit: {
        ...
        clearConfirmTitle: 'Cancellare tutto il registro attività?',
        clearConfirmText: 'Questa operazione elimina definitivamente tutte le voci e non può essere annullata.',
        clearConfirmOk: 'Cancella',
        clearConfirmCancel: 'Annulla',
        clearSuccess: 'Registro attività cancellato',
        clearFailed: 'Impossibile cancellare il registro',
        colTime: 'Ora',
        colUser: 'Utente',
        colAction: 'Azione',
        colIp: 'IP',
        ...
        filterUser: 'Filtra per utente',
        count: '{{count}} voci',
        loadFailed: 'Impossibile caricare il registro attività',
        enableSuccess: 'Registro attività abilitato',
        disableSuccess: 'Registro attività disabilitato',
        updateFailed: 'Impossibile aggiornare l\'impostazione',
        actions: {
          login: 'accesso',
          logout: 'disconnessione',
          changePassword: 'cambia la propria password',
          createUser: 'crea utente',
          updateUser: 'aggiorna utente',
          deleteUser: 'elimina utente',
          changeUserPassword: 'cambia password utente',
          auditConfig: 'modifica impostazioni registro',
          clearAudit: 'cancella registro',
          gpio: 'pulsante accensione/reset',
          reboot: 'riavvia dispositivo',
          usbRecover: 'ripristina USB',
          sshEnable: 'abilita SSH',
          sshDisable: 'disabilita SSH',
          hdmiEnable: 'abilita HDMI',
          hdmiDisable: 'disabilita HDMI',
          hdmiReset: 'ripristina HDMI',
          mdnsEnable: 'abilita mDNS',
          mdnsDisable: 'disabilita mDNS',
          hostname: 'imposta hostname',
          webTitle: 'imposta titolo web',
          tls: 'configura TLS',
          oled: 'configura OLED',
          swap: 'configura swap',
          memoryLimit: 'imposta limite memoria',
          virtualDevice: 'configura dispositivo virtuale',
          mouseJiggler: 'imposta mouse jiggler',
          runScript: 'esegui script',
          uploadScript: 'carica script',
          deleteScript: 'elimina script',
          autostartSet: 'imposta avvio automatico',
          autostartDelete: 'elimina avvio automatico',
          terminal: 'apri terminale web',
          hidPaste: 'incolla testo',
          hidMode: 'cambia modalità HID',
          hidReset: 'ripristina HID',
          shortcutAdd: 'aggiungi scorciatoia',
          shortcutDelete: 'elimina scorciatoia',
          leaderKey: 'imposta tasto leader',
          setDns: 'imposta DNS',
          setIp: 'imposta indirizzo IP',
          wifiConnect: 'connetti Wi-Fi',
          wifiDisconnect: 'disconnetti Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'imposta nome MAC',
          wolMacDelete: 'elimina MAC',
          imageMount: 'monta supporto virtuale',
          imageDelete: 'elimina immagine',
          imageDownload: 'scarica immagine',
          firmwareUpdate: 'aggiorna firmware',
          firmwareUpdateOffline: 'aggiorna firmware (offline)',
          firmwarePreview: 'imposta canale anteprima',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'avvia Tailscale',
          tsStop: 'ferma Tailscale',
          tsRestart: 'riavvia Tailscale',
          tsInstall: 'installa Tailscale',
          tsUninstall: 'disinstalla Tailscale',
          tsLogin: 'accesso Tailscale',
          tsLogout: 'disconnessione Tailscale'
        }
      },
      account: {
        title: 'Account',
