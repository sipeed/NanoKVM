    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Salvato. La connessione si interromperà ora — riapri NanoKVM su {{url}}',
          warning: "La modifica dell'indirizzo IP disconnette la sessione corrente. Un valore errato può bloccarti fuori dall'interfaccia web (il ripristino richiede quindi scheda SD/accesso fisico). Assicurati che indirizzo, maschera e gateway siano corretti.",
          confirmTitle: "Cambiare l'indirizzo IP?",
          confirmStatic: 'La connessione cablata verrà riconfigurata immediatamente e questa sessione verrà interrotta. Poi apri NanoKVM su {{url}}. Continuare?',
