  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP アドレス',
          description: '有線接続 (eth0) を設定します',
          dhcp: 'DHCP',
          static: '手動',
          addressing: 'IPv4 設定',
          dhcpDescription: 'IP アドレスは DHCP から自動的に取得されます',
          staticDescription: '固定 IP アドレス、サブネットマスク、ゲートウェイを設定します',
          ipAddress: 'IP アドレス',
          subnetMask: 'サブネットマスク',
          gateway: 'ゲートウェイ',
          save: '保存',
          unsaved: '未保存の変更',
          invalidAddress: '有効な IP アドレスを入力してください',
          invalidMask: '有効なサブネットマスクを入力してください',
          invalidGateway: '有効なゲートウェイアドレスを入力してください',
          gatewaySubnet: 'ゲートウェイは IP アドレスと同じサブネットにある必要があります',
          saveFailed: 'IP 設定を保存できませんでした',
          savedDhcp: 'DHCP に切り替えました。IP アドレスが間もなく変わる可能性があります。',
          savedReconnect: '保存しました。接続が切断されます — {{url}} で NanoKVM を再度開き、5 分以内に確定してください。確定しない場合は元に戻ります。',
          confirmPendingTitle: '新しい IP アドレスを確定',
          confirmPendingText: '確定しない場合、{{time}} 後に以前の構成に戻ります。',
          confirmKeep: 'この構成を保持',
          confirmed: 'IP 構成を確定しました',
          confirmFailed: '確定に失敗しました',
          reverted: '未確定 — 以前の構成に戻りました',
          warning: 'IP アドレスを変更するとこのセッションが切断されます。その後 5 分以内に新しいアドレスで再接続して確定する必要があります。確定しない場合、デバイスは自動的に以前の構成に戻ります。アドレス、マスク、ゲートウェイが正しいことを確認してください。',
          confirmTitle: 'IP アドレスを変更しますか？',
          confirmStatic: '有線接続がただちに再構成され、このセッションは切断されます。{{url}} で再接続し、5 分以内に確定してください。確定しない場合は自動的に元に戻ります。続行しますか？',
          confirmDhcp: '有線接続がただちに DHCP に切り替わり、このセッションが切断される場合があります。続行しますか？',
          confirmOk: '適用',
          confirmCancel: 'キャンセル'
        }
      },
      ...
      users: {
        ...
        roleOperator: 'KVM の使用:映像、キーボード、マウス、電源ボタン',
        roleViewer: '映像の閲覧のみ',
      ...
      audit: {
        ...
        refresh: '更新',
        clearLog: 'ログを消去',
        clearConfirmTitle: 'アクティビティログをすべて消去しますか？',
        clearConfirmText: 'すべてのログエントリが完全に削除され、元に戻せません。',
        clearConfirmOk: '消去',
        clearConfirmCancel: 'キャンセル',
        clearSuccess: 'アクティビティログを消去しました',
        clearFailed: 'アクティビティログを消去できませんでした',
        colTime: '時刻',
        colUser: 'ユーザー',
        colAction: '操作',
        colIp: 'IP',
        ...
        failure: '失敗',
        allResults: 'すべての結果',
        filterUser: 'ユーザーで絞り込み',
        count: '{{count}} 件',
        loadFailed: '操作ログの読み込みに失敗しました',
        enableSuccess: '操作ログを有効にしました',
        disableSuccess: '操作ログを無効にしました',
        updateFailed: '設定の更新に失敗しました',
        actions: {
          login: 'ログイン',
          logout: 'ログアウト',
          changePassword: '自分のパスワード変更',
          createUser: 'ユーザー作成',
          updateUser: 'ユーザー更新',
          deleteUser: 'ユーザー削除',
          changeUserPassword: 'ユーザーのパスワード変更',
          auditConfig: 'ログ設定の変更',
          clearAudit: 'ログを消去',
          gpio: '電源/リセットボタン',
          reboot: 'デバイス再起動',
          ...
          sshEnable: 'SSH を有効化',
          sshDisable: 'SSH を無効化',
          hdmiEnable: 'HDMI を有効化',
          hdmiDisable: 'HDMI を無効化',
          hdmiReset: 'HDMI をリセット',
          mdnsEnable: 'mDNS を有効化',
          mdnsDisable: 'mDNS を無効化',
          hostname: 'ホスト名を設定',
          webTitle: 'Web タイトルを設定',
          tls: 'TLS を設定',
          oled: 'OLED を設定',
          swap: 'スワップを設定',
          memoryLimit: 'メモリ上限を設定',
          virtualDevice: '仮想デバイスを設定',
          mouseJiggler: 'マウスジグラーを設定',
          runScript: 'スクリプト実行',
          uploadScript: 'スクリプトをアップロード',
          deleteScript: 'スクリプト削除',
          autostartSet: '自動起動を設定',
          autostartDelete: '自動起動を削除',
          terminal: 'Web ターミナルを開く',
          hidPaste: 'テキスト貼り付け',
          hidMode: 'HID モード変更',
          hidReset: 'HID をリセット',
          shortcutAdd: 'ショートカット追加',
          shortcutDelete: 'ショートカット削除',
          leaderKey: 'リーダーキーを設定',
          setDns: 'DNS を設定',
          setIp: 'IP アドレスを設定',
          wifiConnect: 'Wi-Fi 接続',
          wifiDisconnect: 'Wi-Fi 切断',
          wol: 'Wake on LAN',
          wolMacName: 'MAC 名を設定',
          wolMacDelete: 'MAC を削除',
          imageMount: '仮想メディアをマウント',
          imageDelete: 'イメージ削除',
          imageDownload: 'イメージをダウンロード',
          firmwareUpdate: 'ファームウェア更新',
          firmwareUpdateOffline: 'ファームウェア更新（オフライン）',
          firmwarePreview: 'プレビューチャンネルを設定',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'Tailscale 起動',
          tsStop: 'Tailscale 停止',
          tsRestart: 'Tailscale 再起動',
          tsInstall: 'Tailscale インストール',
          tsUninstall: 'Tailscale アンインストール',
          tsLogin: 'Tailscale ログイン',
          tsLogout: 'Tailscale ログアウト'
        }
      },
      account: {
        title: 'アカウント',
