  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP 주소',
          description: '유선 연결(eth0) 구성',
          dhcp: 'DHCP',
          static: '수동',
          addressing: 'IPv4 구성',
          dhcpDescription: 'IP 주소는 DHCP에서 자동으로 할당됩니다',
          staticDescription: '고정 IP 주소, 서브넷 마스크 및 게이트웨이를 설정합니다',
          ipAddress: 'IP 주소',
          subnetMask: '서브넷 마스크',
          gateway: '게이트웨이',
          save: '저장',
          unsaved: '저장되지 않은 변경사항',
          invalidAddress: '유효한 IP 주소를 입력하세요',
          invalidMask: '유효한 서브넷 마스크를 입력하세요',
          invalidGateway: '유효한 게이트웨이 주소를 입력하세요',
          gatewaySubnet: '게이트웨이는 IP 주소와 동일한 서브넷에 있어야 합니다',
          saveFailed: 'IP 설정을 저장하지 못했습니다',
          savedDhcp: 'DHCP로 전환했습니다. IP 주소가 곧 변경될 수 있습니다.',
          savedReconnect: '저장됨. 연결이 곧 끊깁니다 — {{url}} 에서 NanoKVM을 다시 열고 5분 이내에 확인하세요. 확인하지 않으면 되돌아갑니다.',
          confirmPendingTitle: '새 IP 주소 확인',
          confirmPendingText: '확인하지 않으면 {{time}} 후 이전 구성으로 되돌아갑니다.',
          confirmKeep: '구성 유지',
          confirmed: 'IP 구성이 확인되었습니다',
          confirmFailed: '확인 실패',
          reverted: '확인되지 않음 — 이전 구성으로 되돌아갔습니다',
          warning: 'IP 주소를 변경하면 이 세션이 끊깁니다. 이후 5분 이내에 새 주소로 다시 연결하여 확인해야 합니다. 확인하지 않으면 장치가 자동으로 이전 구성으로 되돌아갑니다. 주소, 마스크, 게이트웨이가 올바른지 확인하세요.',
          confirmTitle: 'IP 주소를 변경하시겠습니까?',
          confirmStatic: '유선 연결이 즉시 재구성되고 이 세션은 끊깁니다. {{url}} 에서 다시 연결하고 5분 이내에 확인하세요. 확인하지 않으면 자동으로 되돌아갑니다. 계속하시겠습니까?',
          confirmDhcp: '유선 연결이 즉시 DHCP로 전환되며 이 세션이 끊길 수 있습니다. 계속하시겠습니까?',
          confirmOk: '적용',
          confirmCancel: '취소'
        }
      },
      ...
      audit: {
        ...
        refresh: '새로 고침',
        clearLog: '로그 지우기',
        clearConfirmTitle: '전체 활동 로그를 지우시겠습니까?',
        clearConfirmText: '모든 로그 항목이 영구적으로 삭제되며 되돌릴 수 없습니다.',
        clearConfirmOk: '지우기',
        clearConfirmCancel: '취소',
        clearSuccess: '활동 로그를 지웠습니다',
        clearFailed: '활동 로그를 지우지 못했습니다',
        colTime: '시간',
        colUser: '사용자',
        colAction: '작업',
        colIp: 'IP',
        ...
        actions: {
          ...
          updateUser: '사용자 수정',
          deleteUser: '사용자 삭제',
          changeUserPassword: '사용자 비밀번호 변경',
          auditConfig: '로그 설정 변경',
          clearAudit: '로그 지우기',
          gpio: '전원/재설정 버튼',
          reboot: '장치 재부팅',
          usbRecover: 'USB 복구',
          ...
          sshDisable: 'SSH 비활성화',
          hdmiEnable: 'HDMI 활성화',
          hdmiDisable: 'HDMI 비활성화',
          hdmiReset: 'HDMI 초기화',
          mdnsEnable: 'mDNS 활성화',
          mdnsDisable: 'mDNS 비활성화',
          hostname: '호스트 이름 설정',
          webTitle: '웹 제목 설정',
          tls: 'TLS 구성',
          oled: 'OLED 구성',
          swap: '스왑 구성',
          memoryLimit: '메모리 한도 설정',
          virtualDevice: '가상 장치 구성',
          mouseJiggler: '마우스 지글러 설정',
          runScript: '스크립트 실행',
          uploadScript: '스크립트 업로드',
          deleteScript: '스크립트 삭제',
          autostartSet: '자동 시작 설정',
          autostartDelete: '자동 시작 삭제',
          terminal: '웹 터미널 열기',
          hidPaste: '텍스트 붙여넣기',
          hidMode: 'HID 모드 변경',
          hidReset: 'HID 초기화',
          shortcutAdd: '단축키 추가',
          shortcutDelete: '단축키 삭제',
          leaderKey: '리더 키 설정',
          setDns: 'DNS 설정',
          setIp: 'IP 주소 설정',
          wifiConnect: 'Wi-Fi 연결',
          wifiDisconnect: 'Wi-Fi 연결 해제',
          wol: 'Wake on LAN',
          wolMacName: 'MAC 이름 설정',
          wolMacDelete: 'MAC 삭제',
          imageMount: '가상 미디어 마운트',
          imageDelete: '이미지 삭제',
          imageDownload: '이미지 다운로드',
          firmwareUpdate: '펌웨어 업데이트',
          firmwareUpdateOffline: '펌웨어 업데이트(오프라인)',
          firmwarePreview: '미리보기 채널 설정',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'Tailscale 시작',
          tsStop: 'Tailscale 중지',
          tsRestart: 'Tailscale 재시작',
          tsInstall: 'Tailscale 설치',
          tsUninstall: 'Tailscale 제거',
          tsLogin: 'Tailscale 로그인',
          tsLogout: 'Tailscale 로그아웃'
        }
      },
      account: {
        title: '계정',
