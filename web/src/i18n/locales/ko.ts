    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: '저장됨. 연결이 곧 끊깁니다 — {{url}} 에서 NanoKVM을 다시 여세요',
          warning: 'IP 주소를 변경하면 현재 세션이 끊깁니다. 잘못된 값을 입력하면 웹 인터페이스에 접속할 수 없게 될 수 있습니다(복구하려면 SD 카드/물리적 접근 필요). 주소, 마스크, 게이트웨이가 올바른지 확인하세요.',
          confirmTitle: 'IP 주소를 변경하시겠습니까?',
          confirmStatic: '유선 연결이 즉시 재구성되고 이 세션은 끊깁니다. 이후 {{url}} 에서 NanoKVM을 여세요. 계속하시겠습니까?',
