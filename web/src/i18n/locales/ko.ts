  ...
  translation: {
    ...
    settings: {
      ...
      users: {
        ...
        roleOperator: 'KVM 사용: 비디오, 키보드, 마우스, 전원 버튼',
        roleViewer: '비디오 보기만 가능',
        changePassword: '비밀번호 변경',
        newPassword: '새 비밀번호',
        ...
        password: '비밀번호',
        delete: '삭제',
        deleteConfirm: '이 사용자를 정말 삭제하시겠습니까?',
      ...
      audit: {
        ...
        filterUser: '사용자로 필터링',
        count: '{{count}}개 항목',
        loadFailed: '활동 로그를 불러오지 못했습니다',
        enableSuccess: '활동 로그가 활성화되었습니다',
        disableSuccess: '활동 로그가 비활성화되었습니다',
        updateFailed: '설정을 업데이트하지 못했습니다'
      },
      account: {
        title: '계정',
        webAccount: '웹 계정',
