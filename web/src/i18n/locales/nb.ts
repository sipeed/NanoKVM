  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP-adresse',
          description: 'Konfigurer den kablede tilkoblingen (eth0)',
          dhcp: 'DHCP',
          static: 'Manuell',
          addressing: 'IPv4-konfigurasjon',
          dhcpDescription: 'IP-adressen hentes automatisk via DHCP',
          staticDescription: 'Angi en fast IP-adresse, subnettmaske og gateway',
          ipAddress: 'IP-adresse',
          subnetMask: 'Subnettmaske',
          gateway: 'Gateway',
          save: 'Lagre',
          ...
          invalidMask: 'Skriv inn en gyldig subnettmaske',
          invalidGateway: 'Skriv inn en gyldig gateway-adresse',
          gatewaySubnet: 'Gatewayen må være i samme subnett som IP-adressen',
          saveFailed: 'Kunne ikke lagre IP-innstillingene',
          savedDhcp: 'Byttet til DHCP. IP-adressen kan snart endres.',
          savedReconnect: 'Lagret. Tilkoblingen brytes nå — åpne NanoKVM på nytt på {{url}} og bekreft der innen 5 minutter, ellers tilbakestilles det.',
          confirmPendingTitle: 'Bekreft ny IP-adresse',
          confirmPendingText: 'Går tilbake til forrige konfigurasjon om {{time}} hvis du ikke bekrefter.',
          confirmKeep: 'Behold konfigurasjon',
          confirmed: 'IP-konfigurasjon bekreftet',
          confirmFailed: 'Bekreftelse mislyktes',
          reverted: 'Ikke bekreftet — gikk tilbake til forrige konfigurasjon',
          warning: 'Endring av IP-adressen kobler fra denne økten. Du har deretter 5 minutter på å koble til den nye adressen igjen og bekrefte; ellers går enheten automatisk tilbake til den forrige konfigurasjonen. Sørg for at adresse, maske og gateway er riktige.',
          confirmTitle: 'Endre IP-adressen?',
          confirmStatic: 'Den kablede tilkoblingen rekonfigureres umiddelbart, og denne økten brytes. Koble til på nytt på {{url}} og bekreft innen 5 minutter, ellers tilbakestilles det automatisk. Fortsette?',
          confirmDhcp: 'Den kablede tilkoblingen bytter umiddelbart til DHCP, og denne økten kan brytes. Fortsette?',
          confirmOk: 'Bruk',
      ...
      users: {
        ...
        rolesTitle: 'Oversikt over roller',
        roleAdmin: 'Full tilgang + brukeradministrasjon',
        roleOperator: 'Bruk av KVM: video, tastatur, mus, strømknapper',
        roleViewer: 'Kun se video',
        changePassword: 'Endre passord',
        newPassword: 'Nytt passord',
        confirmPassword: 'Bekreft passord',
        pwdMismatch: 'Passordene stemmer ikke overens',
        pwdSuccess: 'Passord endret',
        pwdFailed: 'Endring av passord mislyktes',
        password: 'Passord',
        delete: 'Slett',
        deleteConfirm: 'Er du sikker på at du vil slette denne brukeren?',
        createSuccess: 'Bruker opprettet',
        createFailed: 'Oppretting mislyktes',
        deleteSuccess: 'Bruker slettet',
        deleteFailed: 'Sletting mislyktes',
        updateSuccess: 'Oppdatert',
        updateFailed: 'Oppdatering mislyktes',
        loadFailed: 'Kunne ikke laste brukere',
        usernameRequired: 'Skriv inn brukernavn',
        passwordRequired: 'Skriv inn passord',
        okBtn: 'Ok',
        cancelBtn: 'Avbryt'
      },
      audit: {
        ...
        refresh: 'Oppdater',
        clearLog: 'Tøm logg',
        clearConfirmTitle: 'Tømme hele aktivitetsloggen?',
        clearConfirmText: 'Dette sletter alle loggoppføringer permanent og kan ikke angres.',
        clearConfirmOk: 'Tøm',
        clearConfirmCancel: 'Avbryt',
        clearSuccess: 'Aktivitetslogg tømt',
        clearFailed: 'Kunne ikke tømme aktivitetsloggen',
        colTime: 'Tid',
        colUser: 'Bruker',
        colAction: 'Handling',
        colIp: 'IP',
        ...
        filterUser: 'Filtrer etter bruker',
        count: '{{count}} oppføringer',
        loadFailed: 'Kunne ikke laste aktivitetsloggen',
        enableSuccess: 'Aktivitetslogg aktivert',
        disableSuccess: 'Aktivitetslogg deaktivert',
        updateFailed: 'Kunne ikke oppdatere innstillingen',
        actions: {
          login: 'innlogging',
          logout: 'utlogging',
          changePassword: 'endre eget passord',
          createUser: 'opprett bruker',
          updateUser: 'oppdater bruker',
          deleteUser: 'slett bruker',
          changeUserPassword: 'endre brukerens passord',
          auditConfig: 'endre logginnstillinger',
          clearAudit: 'tøm logg',
          gpio: 'av/på-/reset-knapp',
          reboot: 'start enheten på nytt',
          usbRecover: 'gjenopprett USB',
          sshEnable: 'aktiver SSH',
          sshDisable: 'deaktiver SSH',
          hdmiEnable: 'aktiver HDMI',
          hdmiDisable: 'deaktiver HDMI',
          hdmiReset: 'tilbakestill HDMI',
          mdnsEnable: 'aktiver mDNS',
          mdnsDisable: 'deaktiver mDNS',
          hostname: 'angi vertsnavn',
          webTitle: 'angi nettittel',
          tls: 'konfigurer TLS',
          oled: 'konfigurer OLED',
          swap: 'konfigurer swap',
          memoryLimit: 'angi minnegrense',
          virtualDevice: 'konfigurer virtuell enhet',
          mouseJiggler: 'angi mouse jiggler',
          runScript: 'kjør skript',
          uploadScript: 'last opp skript',
          deleteScript: 'slett skript',
          autostartSet: 'angi autostart',
          autostartDelete: 'slett autostart',
          terminal: 'åpne nettterminal',
          hidPaste: 'lim inn tekst',
          hidMode: 'endre HID-modus',
          hidReset: 'tilbakestill HID',
          shortcutAdd: 'legg til snarvei',
          shortcutDelete: 'slett snarvei',
          leaderKey: 'angi leader-tast',
          setDns: 'angi DNS',
          setIp: 'angi IP-adresse',
          wifiConnect: 'koble til Wi-Fi',
          wifiDisconnect: 'koble fra Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'angi MAC-navn',
          wolMacDelete: 'slett MAC',
          imageMount: 'monter virtuelt medie',
          imageDelete: 'slett image',
          imageDownload: 'last ned image',
          firmwareUpdate: 'oppdater fastvare',
          firmwareUpdateOffline: 'oppdater fastvare (frakoblet)',
          firmwarePreview: 'angi forhåndsvisningskanal',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'start Tailscale',
          tsStop: 'stopp Tailscale',
          tsRestart: 'start Tailscale på nytt',
          tsInstall: 'installer Tailscale',
          tsUninstall: 'avinstaller Tailscale',
          tsLogin: 'Tailscale-innlogging',
          tsLogout: 'Tailscale-utlogging'
        }
      },
      account: {
        title: 'Konto',
