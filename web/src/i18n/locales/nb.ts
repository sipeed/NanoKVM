    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Lagret. Tilkoblingen brytes nå — åpne NanoKVM på nytt på {{url}}',
          warning: 'Endring av IP-adressen kobler fra den gjeldende økten. En feil verdi kan låse deg ute av webgrensesnittet (gjenoppretting krever da SD-kort/fysisk tilgang). Sørg for at adresse, maske og gateway er riktige.',
          confirmTitle: 'Endre IP-adressen?',
          confirmStatic: 'Den kablede tilkoblingen rekonfigureres umiddelbart, og denne økten brytes. Åpne deretter NanoKVM på {{url}}. Fortsette?',
