  ...
  translation: {
    ...
    settings: {
      ...
      users: {
        ...
        rolesTitle: 'Rolleoversikt',
        roleAdmin: 'Full tilgang + brukerhåndtering',
        roleOperator: 'KVM-bruk: stream, tastatur, mus, av/på-knapper',
        roleViewer: 'Kun stream-visning',
        changePassword: 'Endre passord',
        newPassword: 'Nytt passord',
        confirmPassword: 'Bekreft passord',
        pwdMismatch: 'Passordene stemmer ikke',
        pwdSuccess: 'Passord endret',
        pwdFailed: 'Kunne ikke endre passord',
        password: 'Passord',
        delete: 'Slett',
