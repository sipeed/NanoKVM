  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP-adres',
          description: 'De bekabelde verbinding (eth0) configureren',
          dhcp: 'DHCP',
          static: 'Handmatig',
          addressing: 'IPv4-configuratie',
          dhcpDescription: 'Het IP-adres wordt automatisch via DHCP verkregen',
          staticDescription: 'Stel een vast IP-adres, subnetmasker en gateway in',
          ipAddress: 'IP-adres',
          subnetMask: 'Subnetmasker',
          gateway: 'Gateway',
          save: 'Opslaan',
          ...
          invalidMask: 'Voer een geldig subnetmasker in',
          invalidGateway: 'Voer een geldig gateway-adres in',
          gatewaySubnet: 'De gateway moet zich in hetzelfde subnet als het IP-adres bevinden',
          saveFailed: 'Kan IP-instellingen niet opslaan',
          savedDhcp: 'Overgeschakeld naar DHCP. Het IP-adres kan binnenkort wijzigen.',
          savedReconnect: 'Opgeslagen. De verbinding wordt nu verbroken — open NanoKVM opnieuw op {{url}} en bevestig daar binnen 5 minuten, anders wordt het teruggezet.',
          confirmPendingTitle: 'Nieuw IP-adres bevestigen',
          confirmPendingText: 'Keert over {{time}} terug naar de vorige configuratie als je niet bevestigt.',
          confirmKeep: 'Configuratie behouden',
          confirmed: 'IP-configuratie bevestigd',
          confirmFailed: 'Bevestiging mislukt',
          reverted: 'Niet bevestigd — teruggekeerd naar de vorige configuratie',
          warning: 'Het wijzigen van het IP-adres verbreekt deze sessie. Je hebt daarna 5 minuten om opnieuw verbinding te maken met het nieuwe adres en te bevestigen; anders keert het apparaat automatisch terug naar de vorige configuratie. Zorg dat adres, masker en gateway correct zijn.',
          confirmTitle: 'IP-adres wijzigen?',
          confirmStatic: 'De bekabelde verbinding wordt direct opnieuw geconfigureerd en deze sessie wordt verbroken. Maak opnieuw verbinding op {{url}} en bevestig binnen 5 minuten, anders wordt het automatisch teruggezet. Doorgaan?',
          confirmDhcp: 'De bekabelde verbinding schakelt direct over naar DHCP en deze sessie kan worden verbroken. Doorgaan?',
          confirmOk: 'Toepassen',
      ...
      users: {
        ...
        colEnabled: 'Actief',
        colActions: 'Acties',
        rolesTitle: 'Overzicht van rollen',
        roleAdmin: 'Volledige toegang + gebruikersbeheer',
        roleOperator: 'KVM-gebruik: video, toetsenbord, muis, aan/uit-knoppen',
        roleViewer: 'Alleen video bekijken',
        changePassword: 'Wachtwoord wijzigen',
        newPassword: 'Nieuw wachtwoord',
        confirmPassword: 'Wachtwoord bevestigen',
        pwdMismatch: 'Wachtwoorden komen niet overeen',
        pwdSuccess: 'Wachtwoord gewijzigd',
        pwdFailed: 'Wijzigen van wachtwoord mislukt',
        password: 'Wachtwoord',
        delete: 'Verwijderen',
      ...
      audit: {
        ...
        clearConfirmTitle: 'Hele activiteitenlogboek wissen?',
        clearConfirmText: 'Hiermee worden alle vermeldingen permanent verwijderd en dit kan niet ongedaan worden gemaakt.',
        clearConfirmOk: 'Wissen',
        clearConfirmCancel: 'Annuleren',
        clearSuccess: 'Activiteitenlogboek gewist',
        clearFailed: 'Kan activiteitenlogboek niet wissen',
        colTime: 'Tijd',
        colUser: 'Gebruiker',
        colAction: 'Actie',
        colIp: 'IP',
        ...
        filterUser: 'Filteren op gebruiker',
        count: '{{count}} items',
        loadFailed: 'Kan activiteitenlogboek niet laden',
        enableSuccess: 'Activiteitenlogboek ingeschakeld',
        disableSuccess: 'Activiteitenlogboek uitgeschakeld',
        updateFailed: 'Kan instelling niet bijwerken',
        actions: {
          login: 'aanmelden',
          logout: 'afmelden',
          changePassword: 'eigen wachtwoord wijzigen',
          createUser: 'gebruiker aanmaken',
          updateUser: 'gebruiker bijwerken',
          deleteUser: 'gebruiker verwijderen',
          changeUserPassword: 'wachtwoord gebruiker wijzigen',
          auditConfig: 'loginstellingen wijzigen',
          clearAudit: 'logboek wissen',
          gpio: 'aan/reset-knop',
          reboot: 'apparaat herstarten',
          usbRecover: 'USB herstellen',
          sshEnable: 'SSH inschakelen',
          sshDisable: 'SSH uitschakelen',
          hdmiEnable: 'HDMI inschakelen',
          hdmiDisable: 'HDMI uitschakelen',
          hdmiReset: 'HDMI resetten',
          mdnsEnable: 'mDNS inschakelen',
          mdnsDisable: 'mDNS uitschakelen',
          hostname: 'hostnaam instellen',
          webTitle: 'webtitel instellen',
          tls: 'TLS configureren',
          oled: 'OLED configureren',
          swap: 'swap configureren',
          memoryLimit: 'geheugenlimiet instellen',
          virtualDevice: 'virtueel apparaat configureren',
          mouseJiggler: 'mouse jiggler instellen',
          runScript: 'script uitvoeren',
          uploadScript: 'script uploaden',
          deleteScript: 'script verwijderen',
          autostartSet: 'autostart instellen',
          autostartDelete: 'autostart verwijderen',
          terminal: 'webterminal openen',
          hidPaste: 'tekst plakken',
          hidMode: 'HID-modus wijzigen',
          hidReset: 'HID resetten',
          shortcutAdd: 'sneltoets toevoegen',
          shortcutDelete: 'sneltoets verwijderen',
          leaderKey: 'leader-toets instellen',
          setDns: 'DNS instellen',
          setIp: 'IP-adres instellen',
          wifiConnect: 'wifi verbinden',
          wifiDisconnect: 'wifi verbreken',
          wol: 'wake on LAN',
          wolMacName: 'MAC-naam instellen',
          wolMacDelete: 'MAC verwijderen',
          imageMount: 'virtueel medium koppelen',
          imageDelete: 'image verwijderen',
          imageDownload: 'image downloaden',
          firmwareUpdate: 'firmware bijwerken',
          firmwareUpdateOffline: 'firmware bijwerken (offline)',
          firmwarePreview: 'previewkanaal instellen',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'Tailscale starten',
          tsStop: 'Tailscale stoppen',
          tsRestart: 'Tailscale herstarten',
          tsInstall: 'Tailscale installeren',
          tsUninstall: 'Tailscale verwijderen',
          tsLogin: 'Tailscale-aanmelding',
          tsLogout: 'Tailscale-afmelding'
        }
      },
      account: {
        title: 'Account',
