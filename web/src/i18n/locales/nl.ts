    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Opgeslagen. De verbinding wordt nu verbroken — open NanoKVM opnieuw op {{url}}',
          warning: 'Het wijzigen van het IP-adres verbreekt je huidige sessie. Een verkeerde waarde kan je buitensluiten van de webinterface (herstel vereist dan SD-kaart/fysieke toegang). Zorg dat adres, masker en gateway correct zijn.',
          confirmTitle: 'IP-adres wijzigen?',
          confirmStatic: 'De bekabelde verbinding wordt direct opnieuw geconfigureerd en deze sessie wordt verbroken. Open daarna NanoKVM op {{url}}. Doorgaan?',
