  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'Adres IP',
          description: 'Konfiguracja połączenia przewodowego (eth0)',
          dhcp: 'DHCP',
          static: 'Ręcznie',
          addressing: 'Konfiguracja IPv4',
          dhcpDescription: 'Adres IP jest uzyskiwany automatycznie przez DHCP',
          staticDescription: 'Ustaw stały adres IP, maskę podsieci i bramę',
          ipAddress: 'Adres IP',
          subnetMask: 'Maska podsieci',
          gateway: 'Brama',
          save: 'Zapisz',
          ...
          invalidMask: 'Wprowadź prawidłową maskę podsieci',
          invalidGateway: 'Wprowadź prawidłowy adres bramy',
          gatewaySubnet: 'Brama musi znajdować się w tej samej podsieci co adres IP',
          saveFailed: 'Nie udało się zapisać ustawień IP',
          savedDhcp: 'Przełączono na DHCP. Adres IP może się wkrótce zmienić.',
          savedReconnect: 'Zapisano. Połączenie zostanie teraz przerwane — otwórz ponownie NanoKVM pod {{url}} i potwierdź tam w ciągu 5 minut, w przeciwnym razie nastąpi przywrócenie.',
          confirmPendingTitle: 'Potwierdź nowy adres IP',
          confirmPendingText: 'Powrót do poprzedniej konfiguracji za {{time}}, jeśli nie potwierdzisz.',
          confirmKeep: 'Zachowaj konfigurację',
          confirmed: 'Konfiguracja IP potwierdzona',
          confirmFailed: 'Potwierdzenie nie powiodło się',
          reverted: 'Niepotwierdzone — przywrócono poprzednią konfigurację',
          warning: 'Zmiana adresu IP przerywa tę sesję. Masz potem 5 minut, aby ponownie połączyć się z nowym adresem i potwierdzić; w przeciwnym razie urządzenie automatycznie wróci do poprzedniej konfiguracji. Upewnij się, że adres, maska i brama są poprawne.',
          confirmTitle: 'Zmienić adres IP?',
          confirmStatic: 'Połączenie przewodowe zostanie natychmiast ponownie skonfigurowane, a ta sesja zostanie przerwana. Połącz się ponownie pod {{url}} i potwierdź w ciągu 5 minut, w przeciwnym razie nastąpi automatyczne przywrócenie. Kontynuować?',
          confirmDhcp: 'Połączenie przewodowe natychmiast przełączy się na DHCP, a ta sesja może zostać przerwana. Kontynuować?',
          confirmOk: 'Zastosuj',
      ...
      users: {
        ...
        roleOperator: 'Używanie KVM: obraz, klawiatura, mysz, przyciski zasilania',
        roleViewer: 'Tylko podgląd obrazu',
        changePassword: 'Zmień hasło',
        newPassword: 'Nowe hasło',
        confirmPassword: 'Potwierdź hasło',
        pwdMismatch: 'Hasła nie są zgodne',
        pwdSuccess: 'Hasło zostało zmienione',
        pwdFailed: 'Zmiana hasła nie powiodła się',
        password: 'Hasło',
        delete: 'Usuń',
      ...
      audit: {
        ...
        clearConfirmTitle: 'Wyczyścić cały dziennik aktywności?',
        clearConfirmText: 'Spowoduje to trwałe usunięcie wszystkich wpisów i nie można tego cofnąć.',
        clearConfirmOk: 'Wyczyść',
        clearConfirmCancel: 'Anuluj',
        clearSuccess: 'Dziennik aktywności wyczyszczony',
        ...
        filterUser: 'Filtruj według użytkownika',
        count: 'Liczba wpisów: {{count}}',
        loadFailed: 'Nie udało się załadować dziennika aktywności',
        enableSuccess: 'Dziennik aktywności włączony',
        disableSuccess: 'Dziennik aktywności wyłączony',
        updateFailed: 'Nie udało się zaktualizować ustawienia',
        actions: {
          login: 'logowanie',
          logout: 'wylogowanie',
          changePassword: 'zmiana własnego hasła',
          createUser: 'utwórz użytkownika',
          updateUser: 'zaktualizuj użytkownika',
          deleteUser: 'usuń użytkownika',
          changeUserPassword: 'zmień hasło użytkownika',
          auditConfig: 'zmień ustawienia dziennika',
          clearAudit: 'wyczyść dziennik',
          gpio: 'przycisk zasilania/reset',
          reboot: 'uruchom ponownie urządzenie',
          usbRecover: 'odzyskaj USB',
          sshEnable: 'włącz SSH',
          sshDisable: 'wyłącz SSH',
          hdmiEnable: 'włącz HDMI',
          hdmiDisable: 'wyłącz HDMI',
          hdmiReset: 'zresetuj HDMI',
          mdnsEnable: 'włącz mDNS',
          mdnsDisable: 'wyłącz mDNS',
          hostname: 'ustaw nazwę hosta',
          webTitle: 'ustaw tytuł strony',
          tls: 'skonfiguruj TLS',
          oled: 'skonfiguruj OLED',
          swap: 'skonfiguruj swap',
          memoryLimit: 'ustaw limit pamięci',
          virtualDevice: 'skonfiguruj urządzenie wirtualne',
          mouseJiggler: 'ustaw mouse jiggler',
          runScript: 'uruchom skrypt',
          uploadScript: 'prześlij skrypt',
          deleteScript: 'usuń skrypt',
          autostartSet: 'ustaw autostart',
          autostartDelete: 'usuń autostart',
          terminal: 'otwórz terminal web',
          hidPaste: 'wklej tekst',
          hidMode: 'zmień tryb HID',
          hidReset: 'zresetuj HID',
          shortcutAdd: 'dodaj skrót',
          shortcutDelete: 'usuń skrót',
          leaderKey: 'ustaw klawisz leader',
          setDns: 'ustaw DNS',
          setIp: 'ustaw adres IP',
          wifiConnect: 'połącz Wi-Fi',
          wifiDisconnect: 'rozłącz Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'ustaw nazwę MAC',
          wolMacDelete: 'usuń MAC',
          imageMount: 'zamontuj nośnik wirtualny',
          imageDelete: 'usuń obraz',
          imageDownload: 'pobierz obraz',
          firmwareUpdate: 'zaktualizuj firmware',
          firmwareUpdateOffline: 'zaktualizuj firmware (offline)',
          firmwarePreview: 'ustaw kanał podglądu',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'uruchom Tailscale',
          tsStop: 'zatrzymaj Tailscale',
          tsRestart: 'uruchom ponownie Tailscale',
          tsInstall: 'zainstaluj Tailscale',
          tsUninstall: 'odinstaluj Tailscale',
          tsLogin: 'logowanie Tailscale',
          tsLogout: 'wylogowanie Tailscale'
        }
      },
      account: {
        title: 'Konto',
