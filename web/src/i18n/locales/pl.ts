    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Zapisano. Połączenie zostanie teraz przerwane — otwórz NanoKVM ponownie pod {{url}}',
          warning: 'Zmiana adresu IP rozłączy bieżącą sesję. Błędna wartość może zablokować dostęp do interfejsu webowego (odzyskanie wymaga wtedy karty SD/dostępu fizycznego). Upewnij się, że adres, maska i brama są poprawne.',
          confirmTitle: 'Zmienić adres IP?',
          confirmStatic: 'Połączenie przewodowe zostanie natychmiast ponownie skonfigurowane, a ta sesja zostanie przerwana. Następnie otwórz NanoKVM pod {{url}}. Kontynuować?',
