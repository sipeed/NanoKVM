  ...
  translation: {
    ...
    settings: {
      ...
      netbird: {
        ...
        updateHint:
          'O cliente instalado continua funcionando. Para atualizá-lo, desinstale o NetBird e instale novamente. Essa operação encerra a conexão NetBird atual, então faça isso pela rede local ou por outra VPN.',
        version: 'Versão',
