  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'Endereço IP',
          description: 'Configure a conexão com fio (eth0)',
          dhcp: 'DHCP',
          static: 'Manual',
          addressing: 'Configuração IPv4',
          dhcpDescription: 'O endereço IP é obtido automaticamente via DHCP',
          staticDescription: 'Defina um endereço IP fixo, máscara de sub-rede e gateway',
          ipAddress: 'Endereço IP',
          subnetMask: 'Máscara de sub-rede',
          gateway: 'Gateway',
          save: 'Salvar',
          unsaved: 'Alterações não salvas',
          invalidAddress: 'Digite um endereço IP válido',
          invalidMask: 'Digite uma máscara de sub-rede válida',
          invalidGateway: 'Digite um endereço de gateway válido',
          gatewaySubnet: 'O gateway deve estar na mesma sub-rede que o endereço IP',
          saveFailed: 'Falha ao salvar as configurações de IP',
          savedDhcp: 'Alterado para DHCP. O endereço IP pode mudar em breve.',
          savedReconnect: 'Salvo. A conexão será encerrada agora — reabra o NanoKVM em {{url}} e confirme lá em até 5 minutos, caso contrário será revertido.',
          confirmPendingTitle: 'Confirmar o novo endereço IP',
          confirmPendingText: 'Voltando à configuração anterior em {{time}} se você não confirmar.',
          confirmKeep: 'Manter configuração',
          confirmed: 'Configuração de IP confirmada',
          confirmFailed: 'Falha na confirmação',
          reverted: 'Não confirmado — voltou à configuração anterior',
          warning: 'Alterar o endereço IP desconecta esta sessão. Você terá então 5 minutos para reconectar no novo endereço e confirmar; caso contrário, o dispositivo volta automaticamente para a configuração anterior. Verifique se o endereço, a máscara e o gateway estão corretos.',
          confirmTitle: 'Alterar o endereço IP?',
          confirmStatic: 'A conexão com fio será reconfigurada imediatamente e esta sessão será encerrada. Reconecte em {{url}} e confirme em até 5 minutos, caso contrário será revertido automaticamente. Continuar?',
          confirmDhcp: 'A conexão com fio mudará para DHCP imediatamente e esta sessão pode ser encerrada. Continuar?',
          confirmOk: 'Aplicar',
      ...
      users: {
        ...
        roleOperator: 'Uso do KVM: vídeo, teclado, mouse, botões de energia',
        roleViewer: 'Apenas visualizar vídeo',
        ...
        password: 'Senha',
        delete: 'Excluir',
        deleteConfirm: 'Deseja realmente excluir este usuário?',
        ...
        usernameRequired: 'Informe o nome de usuário',
      ...
      audit: {
        ...
        clearConfirmTitle: 'Limpar todo o registro de atividades?',
        clearConfirmText: 'Isso exclui permanentemente todas as entradas e não pode ser desfeito.',
        clearConfirmOk: 'Limpar',
        clearConfirmCancel: 'Cancelar',
        clearSuccess: 'Registro de atividades limpo',
        clearFailed: 'Falha ao limpar o registro',
        colTime: 'Hora',
        colUser: 'Usuário',
        colAction: 'Ação',
        colIp: 'IP',
        ...
        loadFailed: 'Falha ao carregar o registro de atividades',
        enableSuccess: 'Registro de atividades ativado',
        disableSuccess: 'Registro de atividades desativado',
        updateFailed: 'Falha ao atualizar a configuração',
        actions: {
          login: 'entrar',
          logout: 'sair',
          changePassword: 'alterar a própria senha',
          createUser: 'criar usuário',
          updateUser: 'atualizar usuário',
          deleteUser: 'excluir usuário',
          changeUserPassword: 'alterar senha do usuário',
          auditConfig: 'alterar configurações do registro',
          clearAudit: 'limpar registro',
          gpio: 'botão liga/reiniciar',
          reboot: 'reiniciar dispositivo',
          usbRecover: 'recuperar USB',
          sshEnable: 'ativar SSH',
          sshDisable: 'desativar SSH',
          hdmiEnable: 'ativar HDMI',
          hdmiDisable: 'desativar HDMI',
          hdmiReset: 'redefinir HDMI',
          mdnsEnable: 'ativar mDNS',
          mdnsDisable: 'desativar mDNS',
          hostname: 'definir nome do host',
          webTitle: 'definir título web',
          tls: 'configurar TLS',
          oled: 'configurar OLED',
          swap: 'configurar swap',
          memoryLimit: 'definir limite de memória',
          virtualDevice: 'configurar dispositivo virtual',
          mouseJiggler: 'definir mouse jiggler',
          runScript: 'executar script',
          uploadScript: 'enviar script',
          deleteScript: 'excluir script',
          autostartSet: 'definir início automático',
          autostartDelete: 'excluir início automático',
          terminal: 'abrir terminal web',
          hidPaste: 'colar texto',
          hidMode: 'alterar modo HID',
          hidReset: 'redefinir HID',
          shortcutAdd: 'adicionar atalho',
          shortcutDelete: 'excluir atalho',
          leaderKey: 'definir tecla líder',
          setDns: 'definir DNS',
          setIp: 'definir endereço IP',
          wifiConnect: 'conectar Wi-Fi',
          wifiDisconnect: 'desconectar Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'definir nome MAC',
          wolMacDelete: 'excluir MAC',
          imageMount: 'montar mídia virtual',
          imageDelete: 'excluir imagem',
          imageDownload: 'baixar imagem',
          firmwareUpdate: 'atualizar firmware',
          firmwareUpdateOffline: 'atualizar firmware (offline)',
          firmwarePreview: 'definir canal de prévia',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'iniciar Tailscale',
          tsStop: 'parar Tailscale',
          tsRestart: 'reiniciar Tailscale',
          tsInstall: 'instalar Tailscale',
          tsUninstall: 'desinstalar Tailscale',
          tsLogin: 'entrar no Tailscale',
          tsLogout: 'sair do Tailscale'
        }
      },
      account: {
        title: 'Conta',
