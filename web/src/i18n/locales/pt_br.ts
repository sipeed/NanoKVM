    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Salvo. A conexão será encerrada agora — reabra o NanoKVM em {{url}}',
          warning: 'Alterar o endereço IP desconecta a sessão atual. Um valor incorreto pode bloquear o acesso à interface web (a recuperação exige cartão SD/acesso físico). Verifique se o endereço, a máscara e o gateway estão corretos.',
          confirmTitle: 'Alterar o endereço IP?',
          confirmStatic: 'A conexão com fio será reconfigurada imediatamente e esta sessão será encerrada. Depois abra o NanoKVM em {{url}}. Continuar?',
