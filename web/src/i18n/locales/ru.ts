  ...
  translation: {
    ...
    settings: {
      ...
      netbird: {
        ...
        updateHint:
          'Установленный клиент продолжает работать. Чтобы обновить его, удалите NetBird и установите заново. Это разорвёт текущее подключение через NetBird, поэтому делайте это из локальной сети или через другой VPN.',
        version: 'Версия',
