  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP-адрес',
          description: 'Настройка проводного подключения (eth0)',
          dhcp: 'DHCP',
          static: 'Вручную',
          addressing: 'Настройка IPv4',
          dhcpDescription: 'IP-адрес назначается автоматически по DHCP',
          staticDescription: 'Задайте фиксированный IP-адрес, маску подсети и шлюз',
          ipAddress: 'IP-адрес',
          subnetMask: 'Маска подсети',
          gateway: 'Шлюз',
          save: 'Сохранить',
          unsaved: 'Несохраненные изменения',
          invalidAddress: 'Введите допустимый IP-адрес',
          invalidMask: 'Введите допустимую маску подсети',
          invalidGateway: 'Введите допустимый адрес шлюза',
          gatewaySubnet: 'Шлюз должен находиться в той же подсети, что и IP-адрес',
          saveFailed: 'Не удалось сохранить настройки IP',
          savedDhcp: 'Переключено на DHCP. IP-адрес может скоро измениться.',
          savedReconnect: 'Сохранено. Соединение сейчас прервётся — снова откройте NanoKVM по адресу {{url}} и подтвердите там в течение 5 минут, иначе настройки будут отменены.',
          confirmPendingTitle: 'Подтвердите новый IP-адрес',
          confirmPendingText: 'Возврат к предыдущей конфигурации через {{time}}, если вы не подтвердите.',
          confirmKeep: 'Сохранить конфигурацию',
          confirmed: 'Конфигурация IP подтверждена',
          confirmFailed: 'Не удалось подтвердить',
          reverted: 'Не подтверждено — возврат к предыдущей конфигурации',
          warning: 'Изменение IP-адреса разорвёт этот сеанс. После этого у вас есть 5 минут, чтобы заново подключиться по новому адресу и подтвердить; иначе устройство автоматически вернётся к предыдущей конфигурации. Убедитесь, что адрес, маска и шлюз указаны верно.',
          confirmTitle: 'Изменить IP-адрес?',
          confirmStatic: 'Проводное подключение будет немедленно перенастроено, и этот сеанс прервётся. Подключитесь заново по адресу {{url}} и подтвердите в течение 5 минут, иначе настройки откатятся автоматически. Продолжить?',
          confirmDhcp: 'Проводное подключение немедленно переключится на DHCP, и текущий сеанс может прерваться. Продолжить?',
          confirmOk: 'Применить',
      ...
      users: {
        ...
        roleOperator: 'Использование KVM: видео, клавиатура, мышь, кнопки питания',
        roleViewer: 'Только просмотр видео',
      ...
      audit: {
        ...
        clearConfirmTitle: 'Очистить весь журнал активности?',
        clearConfirmText: 'Это безвозвратно удалит все записи и не может быть отменено.',
        clearConfirmOk: 'Очистить',
        clearConfirmCancel: 'Отмена',
        clearSuccess: 'Журнал активности очищен',
        ...
        enableSuccess: 'Журнал действий включён',
        disableSuccess: 'Журнал действий отключён',
        updateFailed: 'Не удалось обновить настройку',
        actions: {
          login: 'вход',
          logout: 'выход',
          changePassword: 'смена своего пароля',
          createUser: 'создать пользователя',
          updateUser: 'изменить пользователя',
          deleteUser: 'удалить пользователя',
          changeUserPassword: 'сменить пароль пользователя',
          auditConfig: 'изменить настройки журнала',
          clearAudit: 'очистить журнал',
          gpio: 'кнопка питания/сброса',
          reboot: 'перезагрузить устройство',
          usbRecover: 'восстановить USB',
          sshEnable: 'включить SSH',
          sshDisable: 'отключить SSH',
          hdmiEnable: 'включить HDMI',
          hdmiDisable: 'отключить HDMI',
          hdmiReset: 'сбросить HDMI',
          mdnsEnable: 'включить mDNS',
          mdnsDisable: 'отключить mDNS',
          hostname: 'задать имя хоста',
          webTitle: 'задать веб-заголовок',
          tls: 'настроить TLS',
          oled: 'настроить OLED',
          swap: 'настроить swap',
          memoryLimit: 'задать лимит памяти',
          virtualDevice: 'настроить виртуальное устройство',
          mouseJiggler: 'настроить mouse jiggler',
          runScript: 'запустить скрипт',
          uploadScript: 'загрузить скрипт',
          deleteScript: 'удалить скрипт',
          autostartSet: 'задать автозапуск',
          autostartDelete: 'удалить автозапуск',
          terminal: 'открыть веб-терминал',
          hidPaste: 'вставить текст',
          hidMode: 'сменить режим HID',
          hidReset: 'сбросить HID',
          shortcutAdd: 'добавить ярлык',
          shortcutDelete: 'удалить ярлык',
          leaderKey: 'задать leader-клавишу',
          setDns: 'задать DNS',
          setIp: 'задать IP-адрес',
          wifiConnect: 'подключить Wi-Fi',
          wifiDisconnect: 'отключить Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'задать имя MAC',
          wolMacDelete: 'удалить MAC',
          imageMount: 'подключить виртуальный носитель',
          imageDelete: 'удалить образ',
          imageDownload: 'скачать образ',
          firmwareUpdate: 'обновить прошивку',
          firmwareUpdateOffline: 'обновить прошивку (офлайн)',
          firmwarePreview: 'задать канал предпросмотра',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'запустить Tailscale',
          tsStop: 'остановить Tailscale',
          tsRestart: 'перезапустить Tailscale',
          tsInstall: 'установить Tailscale',
          tsUninstall: 'удалить Tailscale',
          tsLogin: 'вход Tailscale',
          tsLogout: 'выход Tailscale'
        }
      },
      account: {
        title: 'Аккаунт',
