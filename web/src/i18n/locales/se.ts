    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Sparat. Anslutningen bryts nu — öppna NanoKVM igen på {{url}}',
          warning: 'Att ändra IP-adressen kopplar bort din nuvarande session. Ett felaktigt värde kan låsa ute dig från webbgränssnittet (återställning kräver då SD-kort/fysisk åtkomst). Se till att adress, mask och gateway är korrekta.',
          confirmTitle: 'Ändra IP-adress?',
          confirmStatic: 'Den trådbundna anslutningen konfigureras om omedelbart och den här sessionen bryts. Öppna sedan NanoKVM på {{url}}. Fortsätta?',
