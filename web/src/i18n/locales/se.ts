  ...
  translation: {
    ...
    settings: {
      ...
      audit: {
        ...
        filterUser: 'Filtrera efter användare',
        count: '{{count}} poster',
        loadFailed: 'Det gick inte att läsa in aktivitetsloggen',
        enableSuccess: 'Aktivitetslogg aktiverad',
        disableSuccess: 'Aktivitetslogg inaktiverad',
        updateFailed: 'Det gick inte att uppdatera inställningen'
      },
      account: {
        title: 'Konto',
