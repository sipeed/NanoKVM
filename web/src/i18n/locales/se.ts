  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP-adress',
          description: 'Konfigurera den trådbundna anslutningen (eth0)',
          dhcp: 'DHCP',
          static: 'Manuell',
          addressing: 'IPv4-konfiguration',
          dhcpDescription: 'IP-adressen hämtas automatiskt via DHCP',
          staticDescription: 'Ange en fast IP-adress, subnätmask och gateway',
          ipAddress: 'IP-adress',
          subnetMask: 'Subnätmask',
          gateway: 'Gateway',
          save: 'Spara',
          ...
          invalidMask: 'Ange en giltig subnätmask',
          invalidGateway: 'Ange en giltig gateway-adress',
          gatewaySubnet: 'Gatewayen måste vara i samma subnät som IP-adressen',
          saveFailed: 'Det gick inte att spara IP-inställningarna',
          savedDhcp: 'Bytte till DHCP. IP-adressen kan snart ändras.',
          savedReconnect: 'Sparat. Anslutningen bryts nu — öppna NanoKVM igen på {{url}} och bekräfta där inom 5 minuter, annars återställs det.',
          confirmPendingTitle: 'Bekräfta ny IP-adress',
          confirmPendingText: 'Återgår till föregående konfiguration om {{time}} om du inte bekräftar.',
          confirmKeep: 'Behåll konfiguration',
          confirmed: 'IP-konfiguration bekräftad',
          confirmFailed: 'Bekräftelsen misslyckades',
          reverted: 'Inte bekräftad — återgick till föregående konfiguration',
          warning: 'Att ändra IP-adressen kopplar bort den här sessionen. Du har sedan 5 minuter på dig att återansluta till den nya adressen och bekräfta; annars återgår enheten automatiskt till föregående konfiguration. Se till att adress, mask och gateway är korrekta.',
          confirmTitle: 'Ändra IP-adress?',
          confirmStatic: 'Den trådbundna anslutningen konfigureras om omedelbart och den här sessionen bryts. Återanslut på {{url}} och bekräfta inom 5 minuter, annars återställs det automatiskt. Fortsätta?',
          confirmDhcp: 'Den trådbundna anslutningen byter omedelbart till DHCP och den här sessionen kan brytas. Fortsätta?',
          confirmOk: 'Använd',
      ...
      audit: {
        ...
        refresh: 'Uppdatera',
        clearLog: 'Rensa logg',
        clearConfirmTitle: 'Rensa hela aktivitetsloggen?',
        clearConfirmText: 'Detta tar permanent bort alla loggposter och kan inte ångras.',
        clearConfirmOk: 'Rensa',
        clearConfirmCancel: 'Avbryt',
        clearSuccess: 'Aktivitetsloggen rensad',
        clearFailed: 'Det gick inte att rensa loggen',
        colTime: 'Tid',
        colUser: 'Användare',
        colAction: 'Åtgärd',
        colIp: 'IP',
        ...
        actions: {
          login: 'inloggning',
          logout: 'utloggning',
          changePassword: 'byt eget lösenord',
          createUser: 'skapa användare',
          updateUser: 'uppdatera användare',
          deleteUser: 'ta bort användare',
          changeUserPassword: 'byt användarens lösenord',
          auditConfig: 'ändra logginställningar',
          clearAudit: 'rensa logg',
          gpio: 'ström-/reset-knapp',
          reboot: 'starta om enheten',
          usbRecover: 'återställ USB',
          sshEnable: 'aktivera SSH',
          sshDisable: 'inaktivera SSH',
          hdmiEnable: 'aktivera HDMI',
          hdmiDisable: 'inaktivera HDMI',
          hdmiReset: 'återställ HDMI',
          mdnsEnable: 'aktivera mDNS',
          mdnsDisable: 'inaktivera mDNS',
          hostname: 'ange värdnamn',
          webTitle: 'ange webbtitel',
          tls: 'konfigurera TLS',
          oled: 'konfigurera OLED',
          swap: 'konfigurera swap',
          memoryLimit: 'ange minnesgräns',
          virtualDevice: 'konfigurera virtuell enhet',
          mouseJiggler: 'ange mouse jiggler',
          runScript: 'kör skript',
          uploadScript: 'ladda upp skript',
          deleteScript: 'ta bort skript',
          autostartSet: 'ange autostart',
          autostartDelete: 'ta bort autostart',
          terminal: 'öppna webbterminal',
          hidPaste: 'klistra in text',
          hidMode: 'ändra HID-läge',
          hidReset: 'återställ HID',
          shortcutAdd: 'lägg till genväg',
          shortcutDelete: 'ta bort genväg',
          leaderKey: 'ange leader-tangent',
          setDns: 'ange DNS',
          setIp: 'ange IP-adress',
          wifiConnect: 'anslut Wi-Fi',
          wifiDisconnect: 'koppla från Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'ange MAC-namn',
          wolMacDelete: 'ta bort MAC',
          imageMount: 'montera virtuellt medium',
          imageDelete: 'ta bort avbild',
          imageDownload: 'ladda ner avbild',
          firmwareUpdate: 'uppdatera firmware',
          firmwareUpdateOffline: 'uppdatera firmware (offline)',
          firmwarePreview: 'ange förhandsgranskningskanal',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'starta Tailscale',
          tsStop: 'stoppa Tailscale',
          tsRestart: 'starta om Tailscale',
          tsInstall: 'installera Tailscale',
          tsUninstall: 'avinstallera Tailscale',
          tsLogin: 'Tailscale-inloggning',
          tsLogout: 'Tailscale-utloggning'
        }
      },
      account: {
        title: 'Konto',
