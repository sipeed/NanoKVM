  ...
  translation: {
    ...
    settings: {
      ...
      netbird: {
        ...
        updateHint:
          'ไคลเอ็นต์ที่ติดตั้งไว้ยังใช้งานได้ หากต้องการอัปเดต ให้ถอนการติดตั้ง NetBird แล้วติดตั้งใหม่ การดำเนินการนี้จะตัดการเชื่อมต่อ NetBird ปัจจุบัน จึงควรทำจากเครือข่ายภายในหรือผ่าน VPN อื่น',
        version: 'เวอร์ชัน',
