const th = {
  translation: {
    ...
    image: {
      ...
      diskOnWarn:
        'การเมานต์อิมเมจจะปิดดิสก์เสมือน ทำให้คอมพิวเตอร์เข้าถึง /data ไม่ได้อีกต่อไป ดำเนินการต่อหรือไม่?',
      diskOffWarn:
        'ดิสก์เสมือนปิดอยู่ ต้องเปิดก่อนจึงจะเมานต์อิมเมจได้ อุปกรณ์ USB ของคอมพิวเตอร์จะเชื่อมต่อใหม่ ดำเนินการต่อหรือไม่?',
      diskShared:
        'ดิสก์เสมือนเปิดอยู่ ดังนั้น /data จึงเป็นแบบอ่านอย่างเดียว ปิดดิสก์เสมือนเพื่อลบหรืออัปโหลดอิมเมจ',
    ...
    download: {
      ...
      diskShared: 'ปิดดิสก์เสมือนก่อน แล้วจึงใช้การดาวน์โหลดอิมเมจ',
    ...
    settings: {
      ...
      device: {
        ...
        diskLocked: 'ปิดอยู่ขณะเมานต์อิมเมจ (เปิดจะยกเลิกการเมานต์)',
        diskCancelMount:
          'การเปิดดิสก์เสมือนจะยกเลิกการเมานต์อิมเมจ และขัดขวางการดาวน์โหลดหรืออัปโหลดอิมเมจที่กำลังดำเนินอยู่ ดำเนินการต่อหรือไม่?',
        diskBreakDownload: 'การเปิดดิสก์เสมือนจะขัดขวางการดาวน์โหลดอิมเมจ ดำเนินการต่อหรือไม่?',
      ...
      netbird: {
        ...
        update: 'อัปเดต',
        updateConfirm: 'อัปเดต NetBird ตอนนี้หรือไม่',
        updateWarning:
          'ไคลเอ็นต์จะหยุดทำงานระหว่างการเปลี่ยน หากคุณเชื่อมต่อผ่าน NetBird การเชื่อมต่อนั้นจะหลุดและควรกลับมาเมื่อไคลเอ็นต์ใหม่เริ่มทำงาน',
        updateAvailable: 'เฟิร์มแวร์นี้มี NetBird เวอร์ชันใหม่กว่า',
        updateHint:
          'ไคลเอ็นต์ที่ติดตั้งไว้ยังใช้งานได้ การอัปเดตจะแทนที่ด้วยเวอร์ชันที่มาพร้อมเฟิร์มแวร์นี้',
        version: 'เวอร์ชัน',
