  ...
  translation: {
    ...
    settings: {
      ...
      users: {
        ...
        roleAdmin: 'สิทธิ์เต็ม + การจัดการผู้ใช้',
        roleOperator: 'ใช้งาน KVM: วิดีโอ คีย์บอร์ด เมาส์ ปุ่มเปิดปิด',
        roleViewer: 'ดูวิดีโอเท่านั้น',
        changePassword: 'เปลี่ยนรหัสผ่าน',
        newPassword: 'รหัสผ่านใหม่',
        confirmPassword: 'ยืนยันรหัสผ่าน',
        pwdMismatch: 'รหัสผ่านไม่ตรงกัน',
        pwdSuccess: 'เปลี่ยนรหัสผ่านสำเร็จ',
        pwdFailed: 'เปลี่ยนรหัสผ่านไม่สำเร็จ',
        password: 'รหัสผ่าน',
        delete: 'ลบ',
        deleteConfirm: 'ต้องการลบผู้ใช้รายนี้หรือไม่?',
      ...
      audit: {
        ...
        filterUser: 'กรองตามผู้ใช้',
        count: '{{count}} รายการ',
        loadFailed: 'ไม่สามารถโหลดบันทึกกิจกรรมได้',
        enableSuccess: 'เปิดใช้งานบันทึกกิจกรรมแล้ว',
        disableSuccess: 'ปิดใช้งานบันทึกกิจกรรมแล้ว',
        updateFailed: 'ไม่สามารถอัปเดตการตั้งค่าได้'
      },
      account: {
        title: 'บัญชี',
