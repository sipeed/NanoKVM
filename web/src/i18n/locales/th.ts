  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'ที่อยู่ IP',
          description: 'ตั้งค่าการเชื่อมต่อแบบใช้สาย (eth0)',
          dhcp: 'DHCP',
          static: 'กำหนดเอง',
          addressing: 'การตั้งค่า IPv4',
          dhcpDescription: 'ที่อยู่ IP จะได้รับโดยอัตโนมัติผ่าน DHCP',
          staticDescription: 'กำหนดที่อยู่ IP แบบคงที่ ซับเน็ตมาสก์ และเกตเวย์',
          ipAddress: 'ที่อยู่ IP',
          subnetMask: 'ซับเน็ตมาสก์',
          gateway: 'เกตเวย์',
          save: 'บันทึก',
          unsaved: 'มีการเปลี่ยนแปลงที่ยังไม่ได้บันทึก',
          invalidAddress: 'กรุณาใส่ที่อยู่ IP ที่ถูกต้อง',
          invalidMask: 'กรุณาใส่ซับเน็ตมาสก์ที่ถูกต้อง',
          invalidGateway: 'กรุณาใส่ที่อยู่เกตเวย์ที่ถูกต้อง',
          gatewaySubnet: 'เกตเวย์ต้องอยู่ในซับเน็ตเดียวกับที่อยู่ IP',
          saveFailed: 'บันทึกการตั้งค่า IP ไม่สำเร็จ',
          savedDhcp: 'เปลี่ยนเป็น DHCP แล้ว ที่อยู่ IP อาจเปลี่ยนในไม่ช้า',
          savedReconnect: 'บันทึกแล้ว การเชื่อมต่อจะหลุดตอนนี้ — เปิด NanoKVM อีกครั้งที่ {{url}} และยืนยันที่นั่นภายใน 5 นาที มิฉะนั้นจะย้อนกลับ',
          confirmPendingTitle: 'ยืนยันที่อยู่ IP ใหม่',
          confirmPendingText: 'จะกลับไปใช้การตั้งค่าก่อนหน้าใน {{time}} หากคุณไม่ยืนยัน',
          confirmKeep: 'เก็บการตั้งค่าไว้',
          confirmed: 'ยืนยันการตั้งค่า IP แล้ว',
          confirmFailed: 'การยืนยันล้มเหลว',
          reverted: 'ไม่ได้ยืนยัน — กลับไปใช้การตั้งค่าก่อนหน้า',
          warning: 'การเปลี่ยนที่อยู่ IP จะตัดการเชื่อมต่อเซสชันนี้ จากนั้นคุณมีเวลา 5 นาทีในการเชื่อมต่อใหม่ที่ที่อยู่ใหม่และยืนยัน มิฉะนั้นอุปกรณ์จะกลับไปใช้การตั้งค่าก่อนหน้าโดยอัตโนมัติ ตรวจสอบให้แน่ใจว่าที่อยู่ มาสก์ และเกตเวย์ถูกต้อง',
          confirmTitle: 'เปลี่ยนที่อยู่ IP หรือไม่?',
          confirmStatic: 'การเชื่อมต่อแบบใช้สายจะถูกตั้งค่าใหม่ทันทีและเซสชันนี้จะหลุด เชื่อมต่อใหม่ที่ {{url}} และยืนยันภายใน 5 นาที มิฉะนั้นจะย้อนกลับโดยอัตโนมัติ ดำเนินการต่อหรือไม่?',
          confirmDhcp: 'การเชื่อมต่อแบบใช้สายจะเปลี่ยนเป็น DHCP ทันทีและเซสชันนี้อาจหลุด ดำเนินการต่อหรือไม่?',
          confirmOk: 'ใช้งาน',
      ...
      audit: {
        ...
        refresh: 'รีเฟรช',
        clearLog: 'ล้างบันทึก',
        clearConfirmTitle: 'ล้างบันทึกกิจกรรมทั้งหมดหรือไม่?',
        clearConfirmText: 'การดำเนินการนี้จะลบรายการบันทึกทั้งหมดอย่างถาวรและไม่สามารถยกเลิกได้',
        clearConfirmOk: 'ล้าง',
        clearConfirmCancel: 'ยกเลิก',
        clearSuccess: 'ล้างบันทึกกิจกรรมแล้ว',
        clearFailed: 'ล้างบันทึกกิจกรรมไม่สำเร็จ',
        colTime: 'เวลา',
        colUser: 'ผู้ใช้',
        colAction: 'การกระทำ',
        colIp: 'IP',
        ...
        actions: {
          login: 'เข้าสู่ระบบ',
          logout: 'ออกจากระบบ',
          changePassword: 'เปลี่ยนรหัสผ่านของตนเอง',
          createUser: 'สร้างผู้ใช้',
          updateUser: 'อัปเดตผู้ใช้',
          deleteUser: 'ลบผู้ใช้',
          changeUserPassword: 'เปลี่ยนรหัสผ่านผู้ใช้',
          auditConfig: 'เปลี่ยนการตั้งค่าบันทึก',
          clearAudit: 'ล้างบันทึก',
          gpio: 'ปุ่มเปิด/รีเซ็ต',
          reboot: 'รีบูตอุปกรณ์',
          usbRecover: 'กู้คืน USB',
          sshEnable: 'เปิด SSH',
          sshDisable: 'ปิด SSH',
          hdmiEnable: 'เปิด HDMI',
          hdmiDisable: 'ปิด HDMI',
          hdmiReset: 'รีเซ็ต HDMI',
          mdnsEnable: 'เปิด mDNS',
          mdnsDisable: 'ปิด mDNS',
          hostname: 'ตั้งชื่อโฮสต์',
          webTitle: 'ตั้งชื่อเว็บ',
          tls: 'ตั้งค่า TLS',
          oled: 'ตั้งค่า OLED',
          swap: 'ตั้งค่า swap',
          memoryLimit: 'ตั้งขีดจำกัดหน่วยความจำ',
          virtualDevice: 'ตั้งค่าอุปกรณ์เสมือน',
          mouseJiggler: 'ตั้งค่า mouse jiggler',
          runScript: 'รันสคริปต์',
          uploadScript: 'อัปโหลดสคริปต์',
          deleteScript: 'ลบสคริปต์',
          autostartSet: 'ตั้งค่าเริ่มอัตโนมัติ',
          autostartDelete: 'ลบเริ่มอัตโนมัติ',
          terminal: 'เปิดเว็บเทอร์มินัล',
          hidPaste: 'วางข้อความ',
          hidMode: 'เปลี่ยนโหมด HID',
          hidReset: 'รีเซ็ต HID',
          shortcutAdd: 'เพิ่มทางลัด',
          shortcutDelete: 'ลบทางลัด',
          leaderKey: 'ตั้งปุ่ม leader',
          setDns: 'ตั้งค่า DNS',
          setIp: 'ตั้งค่าที่อยู่ IP',
          wifiConnect: 'เชื่อมต่อ Wi-Fi',
          wifiDisconnect: 'ตัดการเชื่อมต่อ Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'ตั้งชื่อ MAC',
          wolMacDelete: 'ลบ MAC',
          imageMount: 'เมานต์สื่อเสมือน',
          imageDelete: 'ลบอิมเมจ',
          imageDownload: 'ดาวน์โหลดอิมเมจ',
          firmwareUpdate: 'อัปเดตเฟิร์มแวร์',
          firmwareUpdateOffline: 'อัปเดตเฟิร์มแวร์ (ออฟไลน์)',
          firmwarePreview: 'ตั้งช่องพรีวิว',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'เริ่ม Tailscale',
          tsStop: 'หยุด Tailscale',
          tsRestart: 'รีสตาร์ต Tailscale',
          tsInstall: 'ติดตั้ง Tailscale',
          tsUninstall: 'ถอนการติดตั้ง Tailscale',
          tsLogin: 'เข้าสู่ระบบ Tailscale',
          tsLogout: 'ออกจากระบบ Tailscale'
        }
      },
      account: {
        title: 'บัญชี',
