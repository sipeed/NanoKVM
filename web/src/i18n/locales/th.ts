    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'บันทึกแล้ว การเชื่อมต่อจะหลุดตอนนี้ — เปิด NanoKVM อีกครั้งที่ {{url}}',
          warning: 'การเปลี่ยนที่อยู่ IP จะตัดการเชื่อมต่อเซสชันปัจจุบันของคุณ ค่าที่ไม่ถูกต้องอาจทำให้คุณเข้าใช้งานหน้าเว็บไม่ได้ (การกู้คืนต้องใช้การ์ด SD/การเข้าถึงทางกายภาพ) ตรวจสอบให้แน่ใจว่าที่อยู่ มาสก์ และเกตเวย์ถูกต้อง',
          confirmTitle: 'เปลี่ยนที่อยู่ IP หรือไม่?',
          confirmStatic: 'การเชื่อมต่อแบบใช้สายจะถูกตั้งค่าใหม่ทันทีและเซสชันนี้จะหลุด หลังจากนั้นให้เปิด NanoKVM ที่ {{url}} ดำเนินการต่อหรือไม่?',
