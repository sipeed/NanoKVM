    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: "Kaydedildi. Bağlantı şimdi kesilecek — NanoKVM'yi {{url}} adresinde yeniden açın",
          warning: 'IP adresini değiştirmek geçerli oturumunuzu sonlandırır. Yanlış bir değer sizi web arayüzünün dışında bırakabilir (kurtarma için SD kart/fiziksel erişim gerekir). Adresin, maskenin ve ağ geçidinin doğru olduğundan emin olun.',
          confirmTitle: 'IP adresi değiştirilsin mi?',
          confirmStatic: "Kablolu bağlantı hemen yeniden yapılandırılacak ve bu oturum sonlanacak. Ardından NanoKVM'yi {{url}} adresinde açın. Devam edilsin mi?",
