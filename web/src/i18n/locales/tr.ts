  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP Adresi',
          description: 'Kablolu bağlantıyı (eth0) yapılandırın',
          dhcp: 'DHCP',
          static: 'Manuel',
          addressing: 'IPv4 Yapılandırması',
          dhcpDescription: "IP adresi DHCP'den otomatik olarak alınır",
          staticDescription: 'Sabit bir IP adresi, alt ağ maskesi ve ağ geçidi ayarlayın',
          ipAddress: 'IP Adresi',
          subnetMask: 'Alt Ağ Maskesi',
          gateway: 'Ağ geçidi',
          save: 'Kaydet',
          ...
          invalidMask: 'Geçerli bir alt ağ maskesi girin',
          invalidGateway: 'Geçerli bir ağ geçidi adresi girin',
          gatewaySubnet: 'Ağ geçidi, IP adresiyle aynı alt ağda olmalıdır',
          saveFailed: 'IP ayarları kaydedilemedi',
          savedDhcp: "DHCP'ye geçildi. IP adresi kısa süre içinde değişebilir.",
          savedReconnect: "Kaydedildi. Bağlantı şimdi kesilecek — NanoKVM'yi {{url}} adresinde yeniden açın ve orada 5 dakika içinde onaylayın, aksi halde geri alınır.",
          confirmPendingTitle: 'Yeni IP adresini onayla',
          confirmPendingText: 'Onaylamazsanız {{time}} içinde önceki yapılandırmaya dönülecek.',
          confirmKeep: 'Yapılandırmayı koru',
          confirmed: 'IP yapılandırması onaylandı',
          confirmFailed: 'Onaylama başarısız',
          reverted: 'Onaylanmadı — önceki yapılandırmaya dönüldü',
          warning: 'IP adresini değiştirmek bu oturumu sonlandırır. Ardından yeni adrese yeniden bağlanıp onaylamak için 5 dakikanız olur; aksi halde cihaz otomatik olarak önceki yapılandırmaya döner. Adresin, maskenin ve ağ geçidinin doğru olduğundan emin olun.',
          confirmTitle: 'IP adresi değiştirilsin mi?',
          confirmStatic: 'Kablolu bağlantı hemen yeniden yapılandırılacak ve bu oturum sonlanacak. {{url}} adresinde yeniden bağlanın ve 5 dakika içinde onaylayın, aksi halde otomatik olarak geri alınır. Devam edilsin mi?',
          confirmDhcp: "Kablolu bağlantı hemen DHCP'ye geçecek ve bu oturum sonlanabilir. Devam edilsin mi?",
          confirmOk: 'Uygula',
          confirmCancel: 'İptal'
        }
      },
      ...
      users: {
        ...
        colEnabled: 'Aktif',
        colActions: 'İşlemler',
        rolesTitle: 'Rol özeti',
        roleAdmin: 'Tam erişim + kullanıcı yönetimi',
        roleOperator: 'KVM kullanımı: video, klavye, fare, güç düğmeleri',
        roleViewer: 'Yalnızca video izleme',
        changePassword: 'Parolayı değiştir',
        newPassword: 'Yeni parola',
        confirmPassword: 'Parolayı onayla',
        pwdMismatch: 'Parolalar eşleşmiyor',
        pwdSuccess: 'Parola başarıyla değiştirildi',
        pwdFailed: 'Parola değiştirilemedi',
        password: 'Parola',
        delete: 'Sil',
        deleteConfirm: 'Bu kullanıcı gerçekten silinsin mi?',
      ...
      audit: {
        ...
        clearConfirmTitle: 'Tüm etkinlik günlüğü temizlensin mi?',
        clearConfirmText: 'Bu, tüm günlük kayıtlarını kalıcı olarak siler ve geri alınamaz.',
        clearConfirmOk: 'Temizle',
        clearConfirmCancel: 'İptal',
        clearSuccess: 'Etkinlik günlüğü temizlendi',
        clearFailed: 'Etkinlik günlüğü temizlenemedi',
        colTime: 'Zaman',
        colUser: 'Kullanıcı',
        colAction: 'Eylem',
        colIp: 'IP',
        ...
        filterUser: 'Kullanıcıya göre filtrele',
        count: '{{count}} kayıt',
        loadFailed: 'Etkinlik günlüğü yüklenemedi',
        enableSuccess: 'Etkinlik günlüğü etkinleştirildi',
        disableSuccess: 'Etkinlik günlüğü devre dışı bırakıldı',
        updateFailed: 'Ayar güncellenemedi',
        actions: {
          login: 'giriş',
          logout: 'çıkış',
          changePassword: 'kendi parolasını değiştir',
          createUser: 'kullanıcı oluştur',
          updateUser: 'kullanıcıyı güncelle',
          deleteUser: 'kullanıcıyı sil',
          changeUserPassword: 'kullanıcı parolasını değiştir',
          auditConfig: 'günlük ayarlarını değiştir',
          clearAudit: 'günlüğü temizle',
          gpio: 'güç/sıfırlama düğmesi',
          reboot: 'cihazı yeniden başlat',
          usbRecover: 'USB\'yi kurtar',
          sshEnable: 'SSH etkinleştir',
          sshDisable: 'SSH devre dışı bırak',
          hdmiEnable: 'HDMI etkinleştir',
          hdmiDisable: 'HDMI devre dışı bırak',
          hdmiReset: 'HDMI sıfırla',
          mdnsEnable: 'mDNS etkinleştir',
          mdnsDisable: 'mDNS devre dışı bırak',
          hostname: 'ana bilgisayar adını ayarla',
          webTitle: 'web başlığını ayarla',
          tls: 'TLS yapılandır',
          oled: 'OLED yapılandır',
          swap: 'takas yapılandır',
          memoryLimit: 'bellek sınırını ayarla',
          virtualDevice: 'sanal aygıtı yapılandır',
          mouseJiggler: 'mouse jiggler ayarla',
          runScript: 'betiği çalıştır',
          uploadScript: 'betik yükle',
          deleteScript: 'betiği sil',
          autostartSet: 'otomatik başlatmayı ayarla',
          autostartDelete: 'otomatik başlatmayı sil',
          terminal: 'web terminali aç',
          hidPaste: 'metni yapıştır',
          hidMode: 'HID modunu değiştir',
          hidReset: 'HID sıfırla',
          shortcutAdd: 'kısayol ekle',
          shortcutDelete: 'kısayol sil',
          leaderKey: 'leader tuşunu ayarla',
          setDns: 'DNS ayarla',
          setIp: 'IP adresi ayarla',
          wifiConnect: 'Wi-Fi bağlan',
          wifiDisconnect: 'Wi-Fi bağlantısını kes',
          wol: 'wake on LAN',
          wolMacName: 'MAC adını ayarla',
          wolMacDelete: 'MAC sil',
          imageMount: 'sanal ortam bağla',
          imageDelete: 'imajı sil',
          imageDownload: 'imaj indir',
          firmwareUpdate: 'ürün yazılımını güncelle',
          firmwareUpdateOffline: 'ürün yazılımını güncelle (çevrimdışı)',
          firmwarePreview: 'önizleme kanalını ayarla',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'Tailscale başlat',
          tsStop: 'Tailscale durdur',
          tsRestart: 'Tailscale yeniden başlat',
          tsInstall: 'Tailscale kur',
          tsUninstall: 'Tailscale kaldır',
          tsLogin: 'Tailscale giriş',
          tsLogout: 'Tailscale çıkış'
        }
      },
      account: {
        title: 'Hesap',
