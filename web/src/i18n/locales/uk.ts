  ...
  translation: {
    ...
    settings: {
      ...
      netbird: {
        ...
        updateHint:
          'Встановлений клієнт продовжує працювати. Щоб оновити його, видаліть NetBird і встановіть знову. Ця дія розірве поточне з’єднання через NetBird, тому виконуйте її з локальної мережі або через інший VPN.',
        version: 'Версія',
