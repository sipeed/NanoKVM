  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP-адреса',
          description: 'Налаштування дротового підключення (eth0)',
          dhcp: 'DHCP',
          static: 'Вручну',
          addressing: 'Налаштування IPv4',
          dhcpDescription: 'IP-адреса отримується автоматично через DHCP',
          staticDescription: 'Задайте фіксовану IP-адресу, маску підмережі та шлюз',
          ipAddress: 'IP-адреса',
          subnetMask: 'Маска підмережі',
          gateway: 'Шлюз',
          save: 'Зберегти',
          unsaved: 'Незбережені зміни',
          invalidAddress: 'Введіть дійсну IP-адресу',
          invalidMask: 'Введіть дійсну маску підмережі',
          invalidGateway: 'Введіть дійсну адресу шлюзу',
          gatewaySubnet: 'Шлюз має бути в тій самій підмережі, що й IP-адреса',
          saveFailed: 'Не вдалося зберегти налаштування IP',
          savedDhcp: 'Перемкнуто на DHCP. IP-адреса може незабаром змінитися.',
          savedReconnect: "Збережено. З'єднання зараз розірветься — знову відкрийте NanoKVM за адресою {{url}} і підтвердьте там протягом 5 хвилин, інакше зміни буде скасовано.",
          confirmPendingTitle: 'Підтвердіть нову IP-адресу',
          confirmPendingText: 'Повернення до попередньої конфігурації через {{time}}, якщо ви не підтвердите.',
          confirmKeep: 'Зберегти конфігурацію',
          confirmed: 'Конфігурацію IP підтверджено',
          confirmFailed: 'Не вдалося підтвердити',
          reverted: 'Не підтверджено — повернуто до попередньої конфігурації',
          warning: 'Зміна IP-адреси розриває цей сеанс. Після цього у вас є 5 хвилин, щоб повторно підключитися за новою адресою та підтвердити; інакше пристрій автоматично повернеться до попередньої конфігурації. Переконайтеся, що адреса, маска та шлюз правильні.',
          confirmTitle: 'Змінити IP-адресу?',
          confirmStatic: 'Дротове підключення буде негайно переналаштовано, і цей сеанс розірветься. Підключіться знову за адресою {{url}} і підтвердьте протягом 5 хвилин, інакше зміни скасуються автоматично. Продовжити?',
          confirmDhcp: 'Дротове підключення негайно перемкнеться на DHCP, і цей сеанс може розірватися. Продовжити?',
          confirmOk: 'Застосувати',
      ...
      users: {
        ...
        roleOperator: 'Використання KVM: відео, клавіатура, миша, кнопки живлення',
        roleViewer: 'Лише перегляд відео',
        changePassword: 'Змінити пароль',
        ...
        password: 'Пароль',
        delete: 'Видалити',
        deleteConfirm: 'Дійсно видалити цього користувача?',
      ...
      audit: {
        ...
        clearConfirmTitle: 'Очистити весь журнал активності?',
        clearConfirmText: 'Це назавжди видалить усі записи й не може бути скасовано.',
        clearConfirmOk: 'Очистити',
        clearConfirmCancel: 'Скасувати',
        clearSuccess: 'Журнал активності очищено',
        clearFailed: 'Не вдалося очистити журнал',
        colTime: 'Час',
        colUser: 'Користувач',
        colAction: 'Дія',
        colIp: 'IP',
        ...
        enableSuccess: 'Журнал дій увімкнено',
        disableSuccess: 'Журнал дій вимкнено',
        updateFailed: 'Не вдалося оновити налаштування',
        actions: {
          login: 'вхід',
          logout: 'вихід',
          changePassword: 'зміна власного пароля',
          createUser: 'створити користувача',
          updateUser: 'оновити користувача',
          deleteUser: 'видалити користувача',
          changeUserPassword: 'змінити пароль користувача',
          auditConfig: 'змінити налаштування журналу',
          clearAudit: 'очистити журнал',
          gpio: 'кнопка живлення/скидання',
          reboot: 'перезавантажити пристрій',
          usbRecover: 'відновити USB',
          sshEnable: 'увімкнути SSH',
          sshDisable: 'вимкнути SSH',
          hdmiEnable: 'увімкнути HDMI',
          hdmiDisable: 'вимкнути HDMI',
          hdmiReset: 'скинути HDMI',
          mdnsEnable: 'увімкнути mDNS',
          mdnsDisable: 'вимкнути mDNS',
          hostname: 'задати ім\'я хоста',
          webTitle: 'задати веб-заголовок',
          tls: 'налаштувати TLS',
          oled: 'налаштувати OLED',
          swap: 'налаштувати swap',
          memoryLimit: 'задати ліміт памʼяті',
          virtualDevice: 'налаштувати віртуальний пристрій',
          mouseJiggler: 'налаштувати mouse jiggler',
          runScript: 'запустити скрипт',
          uploadScript: 'завантажити скрипт',
          deleteScript: 'видалити скрипт',
          autostartSet: 'задати автозапуск',
          autostartDelete: 'видалити автозапуск',
          terminal: 'відкрити веб-термінал',
          hidPaste: 'вставити текст',
          hidMode: 'змінити режим HID',
          hidReset: 'скинути HID',
          shortcutAdd: 'додати ярлик',
          shortcutDelete: 'видалити ярлик',
          leaderKey: 'задати leader-клавішу',
          setDns: 'задати DNS',
          setIp: 'задати IP-адресу',
          wifiConnect: 'підключити Wi-Fi',
          wifiDisconnect: 'відключити Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'задати ім\'я MAC',
          wolMacDelete: 'видалити MAC',
          imageMount: 'підключити віртуальний носій',
          imageDelete: 'видалити образ',
          imageDownload: 'завантажити образ',
          firmwareUpdate: 'оновити прошивку',
          firmwareUpdateOffline: 'оновити прошивку (офлайн)',
          firmwarePreview: 'задати канал попереднього перегляду',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'запустити Tailscale',
          tsStop: 'зупинити Tailscale',
          tsRestart: 'перезапустити Tailscale',
          tsInstall: 'встановити Tailscale',
          tsUninstall: 'видалити Tailscale',
          tsLogin: 'вхід Tailscale',
          tsLogout: 'вихід Tailscale'
        }
      },
      account: {
