const uk = {
  translation: {
    ...
    image: {
      ...
      diskOnWarn:
        "Монтування образу вимикає віртуальний диск, тому комп'ютер більше не має доступу до /data. Продовжити?",
      diskOffWarn:
        "Віртуальний диск вимкнено, його треба увімкнути для монтування образу. USB-пристрої комп'ютера буде перепідключено. Продовжити?",
      diskShared:
        'Віртуальний диск увімкнено, тому /data тут лише для читання. Вимкніть його, щоб видаляти або завантажувати образи.',
    ...
    download: {
      ...
      diskShared:
        'Спочатку вимкніть віртуальний диск, а потім скористайтеся завантаженням образів.',
      diskOff: 'Вимкнути віртуальний диск',
    ...
    settings: {
      ...
      device: {
        ...
        diskLocked: 'Вимкнено, поки змонтовано образ (увімкнення скасує монтування)',
        diskCancelMount:
          'Увімкнення віртуального диска скасує змонтований образ і перерве поточне завантаження чи вивантаження образу. Продовжити?',
        diskBreakDownload:
          'Увімкнення віртуального диска перерве завантаження образів. Продовжити?',
      ...
      netbird: {
        ...
        update: 'Оновити',
        updateConfirm: 'Оновити NetBird зараз?',
        updateWarning:
          'На час заміни клієнт зупиняється. Якщо ви підключені через NetBird, це з’єднання обірветься і має відновитися після запуску нового клієнта.',
        updateAvailable: 'Ця прошивка містить новішу версію NetBird',
        updateHint:
          'Встановлений клієнт продовжує працювати. Оновлення замінить його версією, що постачається з цією прошивкою.',
        version: 'Версія',
