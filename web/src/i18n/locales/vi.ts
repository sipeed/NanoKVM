  ...
  translation: {
    ...
    settings: {
      ...
      users: {
        ...
        colRole: 'Vai trò',
        colEnabled: 'Hoạt động',
        colActions: 'Hành động',
        rolesTitle: 'Tổng quan vai trò',
        roleAdmin: 'Truy cập đầy đủ + quản lý người dùng',
        roleOperator: 'Sử dụng KVM: luồng, bàn phím, chuột, nút nguồn',
        roleViewer: 'Chỉ xem luồng',
        changePassword: 'Đổi mật khẩu',
        newPassword: 'Mật khẩu mới',
        confirmPassword: 'Xác nhận mật khẩu',
        pwdMismatch: 'Mật khẩu không khớp',
        pwdSuccess: 'Đổi mật khẩu thành công',
        pwdFailed: 'Không thể đổi mật khẩu',
        password: 'Mật khẩu',
        delete: 'Xóa',
        ...
        loadFailed: 'Tải người dùng thất bại',
