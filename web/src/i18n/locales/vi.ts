  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'Địa chỉ IP',
          description: 'Cấu hình kết nối có dây (eth0)',
          dhcp: 'DHCP',
          static: 'Thủ công',
          addressing: 'Cấu hình IPv4',
          dhcpDescription: 'Địa chỉ IP được lấy tự động qua DHCP',
          staticDescription: 'Đặt địa chỉ IP cố định, mặt nạ mạng con và cổng',
          ipAddress: 'Địa chỉ IP',
          subnetMask: 'Mặt nạ mạng con',
          gateway: 'Cổng',
          save: 'Lưu',
          ...
          invalidMask: 'Vui lòng nhập mặt nạ mạng con hợp lệ',
          invalidGateway: 'Vui lòng nhập địa chỉ cổng hợp lệ',
          gatewaySubnet: 'Cổng phải nằm trong cùng mạng con với địa chỉ IP',
          saveFailed: 'Không thể lưu cài đặt IP',
          savedDhcp: 'Đã chuyển sang DHCP. Địa chỉ IP có thể sớm thay đổi.',
          savedReconnect: 'Đã lưu. Kết nối sẽ ngắt ngay bây giờ — mở lại NanoKVM tại {{url}} và xác nhận ở đó trong vòng 5 phút, nếu không sẽ hoàn nguyên.',
          confirmPendingTitle: 'Xác nhận địa chỉ IP mới',
          confirmPendingText: 'Sẽ quay lại cấu hình trước đó sau {{time}} nếu bạn không xác nhận.',
          confirmKeep: 'Giữ cấu hình',
          confirmed: 'Đã xác nhận cấu hình IP',
          confirmFailed: 'Xác nhận thất bại',
          reverted: 'Chưa xác nhận — đã quay lại cấu hình trước đó',
          warning: 'Việc thay đổi địa chỉ IP sẽ ngắt phiên này. Sau đó bạn có 5 phút để kết nối lại với địa chỉ mới và xác nhận; nếu không, thiết bị sẽ tự động quay lại cấu hình trước đó. Hãy đảm bảo địa chỉ, mặt nạ và cổng là chính xác.',
          confirmTitle: 'Thay đổi địa chỉ IP?',
          confirmStatic: 'Kết nối có dây sẽ được cấu hình lại ngay lập tức và phiên này sẽ ngắt. Kết nối lại tại {{url}} và xác nhận trong vòng 5 phút, nếu không sẽ tự động hoàn nguyên. Tiếp tục?',
          confirmDhcp: 'Kết nối có dây sẽ chuyển sang DHCP ngay lập tức và phiên này có thể bị ngắt. Tiếp tục?',
          confirmOk: 'Áp dụng',
          confirmCancel: 'Hủy'
        }
      },
      ...
      users: {
        ...
        colRole: 'Vai trò',
        colEnabled: 'Đang hoạt động',
        colActions: 'Hành động',
        rolesTitle: 'Tổng quan vai trò',
        roleAdmin: 'Toàn quyền + quản lý người dùng',
        roleOperator: 'Dùng KVM: video, bàn phím, chuột, nút nguồn',
        roleViewer: 'Chỉ xem video',
        changePassword: 'Đổi mật khẩu',
      ...
      audit: {
        ...
        clearConfirmTitle: 'Xóa toàn bộ nhật ký hoạt động?',
        clearConfirmText: 'Thao tác này xóa vĩnh viễn tất cả các mục và không thể hoàn tác.',
        clearConfirmOk: 'Xóa',
        clearConfirmCancel: 'Hủy',
        clearSuccess: 'Đã xóa nhật ký hoạt động',
        clearFailed: 'Không thể xóa nhật ký hoạt động',
        colTime: 'Thời gian',
        colUser: 'Người dùng',
        colAction: 'Hành động',
        colIp: 'IP',
        ...
        enableSuccess: 'Đã bật nhật ký hoạt động',
        disableSuccess: 'Đã tắt nhật ký hoạt động',
        updateFailed: 'Không thể cập nhật cài đặt',
        actions: {
          login: 'đăng nhập',
          logout: 'đăng xuất',
          changePassword: 'đổi mật khẩu của mình',
          createUser: 'tạo người dùng',
          updateUser: 'cập nhật người dùng',
          deleteUser: 'xóa người dùng',
          changeUserPassword: 'đổi mật khẩu người dùng',
          auditConfig: 'thay đổi cài đặt nhật ký',
          clearAudit: 'xóa nhật ký',
          gpio: 'nút nguồn/khởi động lại',
          reboot: 'khởi động lại thiết bị',
          usbRecover: 'khôi phục USB',
          sshEnable: 'bật SSH',
          sshDisable: 'tắt SSH',
          hdmiEnable: 'bật HDMI',
          hdmiDisable: 'tắt HDMI',
          hdmiReset: 'đặt lại HDMI',
          mdnsEnable: 'bật mDNS',
          mdnsDisable: 'tắt mDNS',
          hostname: 'đặt tên máy chủ',
          webTitle: 'đặt tiêu đề web',
          tls: 'cấu hình TLS',
          oled: 'cấu hình OLED',
          swap: 'cấu hình swap',
          memoryLimit: 'đặt giới hạn bộ nhớ',
          virtualDevice: 'cấu hình thiết bị ảo',
          mouseJiggler: 'đặt mouse jiggler',
          runScript: 'chạy tập lệnh',
          uploadScript: 'tải lên tập lệnh',
          deleteScript: 'xóa tập lệnh',
          autostartSet: 'đặt tự khởi động',
          autostartDelete: 'xóa tự khởi động',
          terminal: 'mở terminal web',
          hidPaste: 'dán văn bản',
          hidMode: 'đổi chế độ HID',
          hidReset: 'đặt lại HID',
          shortcutAdd: 'thêm phím tắt',
          shortcutDelete: 'xóa phím tắt',
          leaderKey: 'đặt phím leader',
          setDns: 'đặt DNS',
          setIp: 'đặt địa chỉ IP',
          wifiConnect: 'kết nối Wi-Fi',
          wifiDisconnect: 'ngắt Wi-Fi',
          wol: 'wake on LAN',
          wolMacName: 'đặt tên MAC',
          wolMacDelete: 'xóa MAC',
          imageMount: 'gắn phương tiện ảo',
          imageDelete: 'xóa image',
          imageDownload: 'tải xuống image',
          firmwareUpdate: 'cập nhật firmware',
          firmwareUpdateOffline: 'cập nhật firmware (ngoại tuyến)',
          firmwarePreview: 'đặt kênh xem trước',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: 'khởi động Tailscale',
          tsStop: 'dừng Tailscale',
          tsRestart: 'khởi động lại Tailscale',
          tsInstall: 'cài đặt Tailscale',
          tsUninstall: 'gỡ Tailscale',
          tsLogin: 'đăng nhập Tailscale',
          tsLogout: 'đăng xuất Tailscale'
        }
      },
      account: {
        title: 'Tài khoản',
