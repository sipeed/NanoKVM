    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: 'Đã lưu. Kết nối sẽ ngắt ngay bây giờ — mở lại NanoKVM tại {{url}}',
          warning: 'Việc thay đổi địa chỉ IP sẽ ngắt phiên hiện tại của bạn. Giá trị sai có thể khiến bạn không truy cập được giao diện web (khi đó khôi phục cần thẻ SD/truy cập vật lý). Hãy đảm bảo địa chỉ, mặt nạ và cổng là chính xác.',
          confirmTitle: 'Thay đổi địa chỉ IP?',
          confirmStatic: 'Kết nối có dây sẽ được cấu hình lại ngay lập tức và phiên này sẽ ngắt. Sau đó mở NanoKVM tại {{url}}. Tiếp tục?',
