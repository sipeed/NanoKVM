  ...
  translation: {
    ...
    settings: {
      ...
      device: {
        ...
        diskBreakDownload: '开启虚拟U盘会中断镜像下载功能，是否继续？',
        network: '虚拟网卡',
      ...
      netbird: {
        ...
        update: '更新',
        updateConfirm: '现在更新 NetBird？',
        updateWarning:
          '替换期间客户端会停止运行。如果您正通过 NetBird 连接，该连接会中断，并应在新客户端启动后恢复。',
        updateAvailable: '此固件附带更新版本的 NetBird',
        updateHint: '已安装的客户端仍可继续使用。更新会将其替换为此固件附带的版本。',
        version: '版本',
        disconnect: '断开连接',
