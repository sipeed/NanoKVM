    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: '已保存。连接即将断开 — 请在 {{url}} 重新打开 NanoKVM',
          warning: '更改 IP 地址会断开当前会话。错误的值可能导致你无法访问 Web 界面（届时需通过 SD 卡/物理访问恢复）。请确保地址、掩码和网关正确无误。',
          confirmTitle: '更改 IP 地址？',
          confirmStatic: '有线连接将立即重新配置，此会话将断开。之后请在 {{url}} 打开 NanoKVM。是否继续？',
