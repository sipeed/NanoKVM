  ...
  translation: {
    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          title: 'IP 位址',
          description: '設定有線連線 (eth0)',
          dhcp: 'DHCP',
          static: '手動',
          addressing: 'IPv4 設定',
          dhcpDescription: 'IP 位址透過 DHCP 自動取得',
          staticDescription: '設定固定 IP 位址、子網路遮罩與閘道',
          ipAddress: 'IP 位址',
          subnetMask: '子網路遮罩',
          gateway: '閘道',
          save: '儲存',
          ...
          invalidMask: '請輸入有效的子網路遮罩',
          invalidGateway: '請輸入有效的閘道位址',
          gatewaySubnet: '閘道必須與 IP 位址位於同一子網路',
          saveFailed: '儲存 IP 設定失敗',
          savedDhcp: '已切換為 DHCP。IP 位址可能很快會變更。',
          savedReconnect: '已儲存。連線即將中斷 — 請在 {{url}} 重新開啟 NanoKVM 並於 5 分鐘內確認，否則將自動還原。',
          confirmPendingTitle: '確認新的 IP 位址',
          confirmPendingText: '若未確認，將在 {{time}} 後還原為先前的設定。',
          confirmKeep: '保留設定',
          confirmed: '已確認 IP 設定',
          confirmFailed: '確認失敗',
          reverted: '未確認 — 已還原為先前的設定',
          warning: '變更 IP 位址會中斷目前的工作階段。之後你有 5 分鐘以新位址重新連線並確認；否則裝置將自動還原為先前的設定。請確認位址、遮罩與閘道正確無誤。',
          confirmTitle: '變更 IP 位址？',
          confirmStatic: '有線連線將立即重新設定，此工作階段將中斷。請在 {{url}} 重新連線並於 5 分鐘內確認，否則將自動還原。是否繼續？',
          confirmDhcp: '有線連線將立即切換為 DHCP，此工作階段可能中斷。是否繼續？',
          confirmOk: '套用',
          confirmCancel: '取消'
        }
      },
      ...
      audit: {
        ...
        refresh: '重新整理',
        clearLog: '清空日誌',
        clearConfirmTitle: '清空整個活動日誌？',
        clearConfirmText: '此操作將永久刪除所有日誌項目且無法復原。',
        clearConfirmOk: '清空',
        clearConfirmCancel: '取消',
        clearSuccess: '活動日誌已清空',
        clearFailed: '清空活動日誌失敗',
        colTime: '時間',
        colUser: '使用者',
        colAction: '操作',
        colIp: 'IP',
        ...
        actions: {
          login: '登入',
          logout: '登出',
          changePassword: '變更本人密碼',
          createUser: '建立使用者',
          updateUser: '更新使用者',
          deleteUser: '刪除使用者',
          changeUserPassword: '變更使用者密碼',
          auditConfig: '變更日誌設定',
          clearAudit: '清空日誌',
          gpio: '電源/重設按鈕',
          reboot: '重新啟動裝置',
          ...
          swap: '設定 swap',
          memoryLimit: '設定記憶體限制',
          virtualDevice: '設定虛擬裝置',
          mouseJiggler: '設定滑鼠抖動',
          runScript: '執行指令稿',
          uploadScript: '上傳指令稿',
          deleteScript: '刪除指令稿',
          autostartSet: '設定自動啟動',
          autostartDelete: '刪除自動啟動',
          terminal: '開啟網頁終端機',
          hidPaste: '貼上文字',
          hidMode: '切換 HID 模式',
          hidReset: '重設 HID',
          shortcutAdd: '新增快速鍵',
          shortcutDelete: '刪除快速鍵',
          leaderKey: '設定 leader 鍵',
          setDns: '設定 DNS',
          setIp: '設定 IP 位址',
          wifiConnect: '連線 Wi-Fi',
          wifiDisconnect: '中斷 Wi-Fi',
          wol: '網路喚醒',
          wolMacName: '設定 MAC 名稱',
          wolMacDelete: '刪除 MAC',
          imageMount: '掛載虛擬媒體',
          imageDelete: '刪除映像',
          imageDownload: '下載映像',
          firmwareUpdate: '更新韌體',
          firmwareUpdateOffline: '更新韌體（離線）',
          firmwarePreview: '設定預覽通道',
          tsUp: 'Tailscale up',
          tsDown: 'Tailscale down',
          tsStart: '啟動 Tailscale',
          tsStop: '停止 Tailscale',
          tsRestart: '重新啟動 Tailscale',
          tsInstall: '安裝 Tailscale',
          tsUninstall: '解除安裝 Tailscale',
          tsLogin: 'Tailscale 登入',
          tsLogout: 'Tailscale 登出'
        }
      },
      account: {
        title: '帳號',
