    ...
    settings: {
      ...
      network: {
        ...
        ip: {
          ...
          savedReconnect: '已儲存。連線即將中斷 — 請在 {{url}} 重新開啟 NanoKVM',
          warning: '變更 IP 位址會中斷目前的工作階段。錯誤的值可能導致你無法存取 Web 介面（屆時需透過 SD 卡/實體存取復原）。請確認位址、遮罩與閘道正確無誤。',
          confirmTitle: '變更 IP 位址？',
          confirmStatic: '有線連線將立即重新設定，此工作階段將中斷。之後請在 {{url}} 開啟 NanoKVM。是否繼續？',
